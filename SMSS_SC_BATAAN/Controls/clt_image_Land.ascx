<%@ Control Language="VB" AutoEventWireup="false" CodeFile="clt_image_Land.ascx.vb" Inherits="clt_image_Land" %>
            ...
            <table class="text1" style="width: 184px; height: 85px;">
                ...
                <tr>
                    <td style="width: 87px">
                        Uploadedby:</td>
                    <td colspan="2">
                        <asp:Label ID="lblupload" runat="server" Width="86px" CssClass="text2" Height="47px"></asp:Label></td>
                </tr>
                <tr>
                    <td style="width: 87px">
                        Position:</td>
