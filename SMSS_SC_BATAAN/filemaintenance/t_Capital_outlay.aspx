...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <asp:UpdatePanel ID="upClass" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                                ...
                                <td style="width: 90%" align="center">
                                    <table width="90%">
                                            ...
                                            <td style="width: 27%; height: 24px;" class="column_Left">
                                                ...
                                                <%--<asp:TextBox ID="TxtClassification" runat="server" Width="54%" CssClass="txtbox_Var" align="center"></asp:TextBox>--%>
                                                    ...
                                                    <asp:DropDownList 
                                                        ...
                                                        AutoPostBack="True"
                                                        OnSelectedIndexChanged="TxtClassification_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                        ...
                                        <tr id="GA" align="center" runat="server">
                                            ...
                                            <td style="width: 50%" class="column_Left" align="center">
                                                <asp:DropDownList ID="DropGA" runat="server" CssClass="drpdownCSS" CausesValidation="false" Width="90%" AutoPostBack="True" OnSelectedIndexChanged="DropGA_SelectedIndexChanged">
                                                </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td style="width: 98%" align="center">
                                    <asp:GridView ID="GvClass" runat="server" Width="98%"
                                        ...
                                        DataKeyNames="ClassificationID,ClassificationName, GA_ID, WithSubClass, GA_Info" AllowPaging="True" PageSize="9" OnSelectedIndexChanged="GvClass_SelectedIndexChanged">
                                        <Columns>
                                            <asp:CommandField ShowSelectButton="True">
                                                <ItemStyle HorizontalAlign="Center" Width="10%" CssClass="LinkBtnSelect" ForeColor="#2977dc"></ItemStyle>
                                            </asp:CommandField>
                                            ...
                                            <asp:BoundField DataField="WithSubClass" HeaderText="With/Without Subclass" Visible="True">
                                                <ItemStyle HorizontalAlign="Center" Width="25%"></ItemStyle>
                                            </asp:BoundField>
                                            <asp:BoundField DataField="GA_Info" HeaderText="General Account" Visible="True">
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="DropGA" EventName="SelectedIndexChanged" />
                    <asp:AsyncPostBackTrigger ControlID="TxtClassification" EventName="SelectedIndexChanged" />
                    <asp:AsyncPostBackTrigger ControlID="WithSubClass" EventName="CheckedChanged" />
                    <asp:AsyncPostBackTrigger ControlID="SrchClassification" EventName="Click" />
                </Triggers>
            </asp:UpdatePanel>
                            ...
                            <td style="width: 90%" align="center">
                                <table width="90%">
                                    ...
                                    <tr align="center">
                                        <td style="width: 31%" class="column_RightBold" align="center">General Account :</td>
                                        <td style="width: 50%" class="column_Left" align="center">
                                            <asp:DropDownList ID="ddGASubClass" runat="server" CssClass="drpdownCSS" Width="90%" CausesValidation="false" AutoPostBack="True" OnSelectedIndexChanged="ddGASubClass_SelectedIndexChanged"
>
                                            </asp:DropDownList>
            ...
            <asp:Button ID="btnShowClass" runat="server" Style="display:none;" />
            <cc1:ModalPopupExtender ID="ModalPopupExtender8" runat="server" TargetControlID="btnShowClass" PopupControlID="PopupClassification" CancelControlID="ImageButton2" BackgroundCssClass="modalBackground">
            </cc1:ModalPopupExtender>
