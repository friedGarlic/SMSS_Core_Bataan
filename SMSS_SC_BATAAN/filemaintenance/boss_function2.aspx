<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="boss_function2.aspx.vb"
            ...
            <div>
                <table width="1020px">
                    ...
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%" align="center">
                            <asp:Button ID="btnSave" runat="server" Width="150px" CssClass="CSButton" Text="SAVE FUNCTION" OnClick="btnSave_Click" OnClientClick="StartProgressBar();"></asp:Button>
                    ...
                    <tr>
                        ...
                        <td style="width: 98%" align="center">
                            <asp:GridView ID="grdFunctions" runat="server" Width="98%" DataKeyNames="Function_Desc,Function_Abb,Office_Code,RC_ID,Function_ID,Func_per_Office_ID" PageSize="15" 
                                AutoGenerateColumns="False" OnSelectedIndexChanged="grdFunctions_SelectedIndexChanged" SkinID="GridViewAA" EmptyDataText="No Data Found.">
