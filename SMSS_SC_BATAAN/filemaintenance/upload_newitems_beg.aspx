<%@ Page Title="Import New Items" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="upload_newitems_beg.aspx.vb"
    Inherits="filemaintenance_upload_newitems_beg" EnableEventValidation="false" StylesheetTheme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <table width="1020px">
            <tr>
                <td style="width: 1%"></td>
                <td style="width: 98%" class="PageTitle">UPLOAD ITEMS BEGINNING BALANCE
                </td>
                <td style="width: 1%"></td>
            </tr>
            <tr>
