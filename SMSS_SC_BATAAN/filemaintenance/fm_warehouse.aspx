            ...
            <tr>
                            ...
                            <td style="width: 98%" align="center">
                              <asp:GridView ID="GvWarehouse" runat="server" Width="98%" 
                                 ...
                                 DataKeyNames="Warehouse_ID,wCode,wName,wAddress" AllowPaging="True" PageSize="9"
                                 OnSelectedIndexChanged="GvWarehouse_SelectedIndexChanged"
                                 OnPageIndexChanging="GvWarehouse_PageIndexChanging">

                                    <Columns>
                                        <asp:TemplateField HeaderText="Hide?" ShowHeader="False">
                                                    <ItemTemplate >
                                                        <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="true" OnCheckedChanged="CheckBox1_CheckedChanged" Checked='<%# Not CBool(Eval("isUsed")) %>' ></asp:CheckBox>
                                                    </ItemTemplate>
