            ...
            <div>
                <table width="1020px">
                    ...
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%">
                            <asp:RadioButtonList ID="RadioButtonList1" runat="server" Width="216px" Font-Size="12pt" Font-Names="Calibri" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" Visible="true">
                    ...
                    <tr>
                        ...
                        <td style="width: 98%" align="right">
                            <asp:Button ID="btnADD" OnClick="btnADD_Click" runat="server" Width="150px" CssClass="CSButton" OnClientClick="StartProgressBar();" Text="ADD MEMBER"></asp:Button>
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
