    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
        <ContentTemplate>
            <div>
                <table width="1020px">
                    <tr>
                        <td colspan="8" class="PageTitle" style="width: 98%">
                            <%--STOCK CARD--%><strong>
                   ...
                   <!-- One-line row: General Account, Sub Classification, Category -->
                    <tr>
                    ...
                    <!-- Hidden Date row -->
                    <tr style="display: none;">
                        <td colspan="8" class="column_RightBold" style="width: 98%; text-align: right;">
                            <%--STOCK CARD--%>Date :
                            <asp:TextBox ID="txtDate" runat="server" CssClass="txtbox_Date" Width="100px"></asp:TextBox>
                        </td>
                    </tr>

                    <!-- (Kept for completeness; now hidden) Original Classification/GA row -->
                    <tr style="display:none;">
                        <td class="column_RightBold" style="width: 25%">
                            <span class="column_RightBold">Classification :</span>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddClass_hiddenCopyNote" runat="server" Width="200px" CssClass="drpdownCSS" Enabled="false"></asp:DropDownList>
                        </td>
                        <td class="column_RightBold" style="width: 100%;">General Account :
                        </td>
                        <td colspan="5">
                            <asp:DropDownList ID="ddGlAccount_hiddenCopyNote" runat="server" Width="525px" CssClass="drpdownCSS" Enabled="false"></asp:DropDownList>
                        </td>
                    </tr>

                    <!-- Search/Filters row (unchanged visibility) -->
                    <tr style="display: none;">
                                 ...
                                 <table style="width: 100%;">
                                     <tr>
                                         ...
                                         <td align="center" rowspan="6" style="width: 20%" valign="middle">
                                             ...
                                             <br />
                                             <asp:Button ID="btnupload" runat="server" Width="48%" CssClass="CSButton" Text="UPLOAD" Enabled ="False" OnClientClick="StartProgressBar();"></asp:Button> <br><br>
                                     ...
                                     <tr>
                                         ...
                                         <td class="column_Left" style="width: 30%">
                                             ...
                                             <asp:TextBox ID="lblequipmentbrand" runat="server" Width="89%" AutoPostBack="True" CssClass="txtbox_Var" TextMode="MultiLine"  ></asp:TextBox>
                                     ...
                                     <tr>
                                         ...
                                         <td class="column_Left" style="width: 30%">
                                             <asp:Label ID="Label5" runat="server" Width="290px" SkinID="Label" Font-Italic="False"></asp:Label>
                                             <asp:TextBox ID="txtRemarks" runat="server" Width="89%" AutoPostBack="True" CssClass="txtbox_Var" TextMode="MultiLine"  ></asp:TextBox>
                                     ...
                                     <tr>
                                         <td colspan="4">
                                             <fieldset style="width: 90%;">
                                                 ...
                                                 <table>
                                                     <tr>
                                                         <td class="column_RightBold" style="width: 119px"><span class="required-label">Acquisition Date :</span></td>
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td class="column_RightBold" style="width: 119px"><span class="required-label">Acquisition Cost :</span></td>
                                                         <td class="column_Left">
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td class="column_Left">
                                                             ...
                                                             <asp:TextBox ID="txtUsefulLife" runat="server" AutoPostBack="True" Enabled="false" Width="50px"  CssClass="txtbox_Var" onchange="return getDepValRate(this);" ></asp:TextBox>
                                        ...
                                        <tr>
                                            <td align="center" colspan="4">
                                                <asp:Panel ID="Panel1" runat="server" CssClass="PanelSize" ScrollBars="Vertical"
                                                    Width="100%">
                                                    <asp:GridView ID="grdLedger1" runat="server" Width="100%" SkinID="GridViewAA" HorizontalAlign="Center" Font-Size="8pt" DataKeyNames="Property_ID, Ledger_ID" OnDataBound = "OnDataBound" OnRowDataBound="grdLedger1_RowDataBound">
              ...
              <asp:Panel ID="popupParticular" runat="server" CssClass="Panel_Popup">
                  <table width="100%">
                      ...
                      <tr>      
                        ...
                        <asp:CheckBox ID="chkHeavyEquipment"
                                      runat="server"
                                      Text="Heavy Equipment"
                                      AutoPostBack="true"
                                      OnCheckedChanged="chkHeavyEquipment_CheckedChanged"
                                      Style="margin-right:5px;" />
                    </div>


                                <asp:GridView ID="grdPropertyInfo" runat="server" SkinID="gvnew" AutoGenerateColumns="false" DataKeyNames="Property_ID, PropertyDetai_ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Chassis Number" AccessibleHeaderText="ChassisNumber">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtChassisNumber" runat="server" Width="150px" ></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Engine Number" AccessibleHeaderText="EngineNumber">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtEngineNumber" runat="server" Width="150px" ></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
