                ...
                <table width="100%">
                    ...
                    <tr>
                        <td colspan="7" style="width: 98%" align="left">&nbsp;
                            ...
                            <asp:DropDownList ID="ddGeneralAccount"
                                runat="server"
                                Width="200px"
                                AutoPostBack="True"
                                CssClass="drpdownCSS"
                                OnSelectedIndexChanged="ddGeneralAccount_SelectedIndexChanged">
                            </asp:DropDownList>
            ...
            OnSelectedIndexChanged="ddCategory_SelectedIndexChanged">
                    ...
                    <tr>
                        <td align="center" class="DivTitle" style="width: 100%">
                            <asp:Label ID="lblSubClass" runat="server" Text="VEHICLE INFORMATION"></asp:Label>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td class="column_Left" style="width: 30%">
                ...
                <asp:DropDownList ID="DrpVehicleName"  CssClass="drpdownCSS" AutoPostBack="true" runat="server" Width="91%" OnSelectedIndexChanged="DrpVehicleName_SelectedIndexChanged"></asp:DropDownList>
                <asp:TextBox ID="txtVehicleName" runat="server" Width="91%" AutoPostBack="True" CssClass="txtbox_Var" Visible="false"></asp:TextBox>
            </td>

             <td class="column_RightBold" style="width: 10%"><span class="required-label">Unit :</span></td>
            <td class="column_Left" style="width: 30%">
                <asp:Label ID="Label1" runat="server" Width="290px" SkinID="Label" Font-Italic="False"></asp:Label>
            ...
            <!-- Do not move this image/upload column -->
            <td align="center" rowspan="6" style="width: 20%" valign="middle">
                ...
                <br />
                <asp:Button ID="Button1" runat="server" Width="48%" CssClass="CSButton" Text="UPLOAD" Enabled="false" OnClientClick="StartProgressBar();"></asp:Button>
            </td>
        </tr>

        <tr>
            <td class="column_RightBold" style="width: 10%"><span class="required-label">Description :</span></td>
            <td class="column_Left" style="width: 30%">
                <asp:Label ID="Label7" runat="server" Width="290px" SkinID="Label" Font-Italic="False" Visible="false"></asp:Label>
                <asp:TextBox ID="txtVehicleDesc" runat="server" Width="91%" AutoPostBack="True" CssClass="txtbox_Var"  ></asp:TextBox>
            </td>
            ...
            <td class="column_Left" style="width: 30%">
                ...
                <asp:TextBox ID="txtVehicleWarranty" runat="server" Width="91%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
            </td>
        </tr>

        <tr>
            <td class="column_RightBold" style="width: 10%">Maker :</td>
            <td class="column_Left" style="width: 30%">
                ...
                <asp:TextBox ID="txtVehicleMake" runat="server" Width="91%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
            </td>

            <td class="column_RightBold" style="width: 10%"><span class="required-label">Quantity :</span></td>
            <td class="column_Left" style="width: 30%">
                <asp:Label ID="Label10" runat="server" Width="290px" SkinID="Label" Font-Italic="False" Visible="false"></asp:Label>
                <asp:TextBox ID="txtVehicleQuantity" runat="server" Width="91%" AutoPostBack="True" CssClass="txtbox_Var"  ></asp:TextBox>
            </td>
        </tr>

        <tr>
            <td class="column_RightBold" style="width: 10%">Type Of Vehicle :</td>
            <td class="column_Left" style="width: 30%">
                <asp:Label ID="Label11" runat="server" Width="290px" SkinID="Label" Font-Italic="False"></asp:Label>
                <asp:TextBox ID="txtVehicleType" runat="server" Width="91%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
            </td>

            <td class="column_RightBold" style="width: 10%">Color :</td>
            <td class="column_Left" style="width: 30%">
                <asp:Label ID="Label8" runat="server" Width="290px" SkinID="Label" Font-Italic="False" Visible="false"></asp:Label>
                <asp:TextBox ID="txtVehicleColor" runat="server" Width="91%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
            </td>
        </tr>
       ...
       <tr>
            ...
            <td class="column_Left" style="width: 30%">
                ...
                <asp:TextBox ID="txtVehiclePowerInput" runat="server" Width="91%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
            </td>

            <td class="column_RightBold" style="width: 10%; vertical-align: central;">Remarks :</td>
            <td class="column_Left" style="width: 30%">
                <asp:TextBox ID="txtRemarks" runat="server" AutoPostBack="True"  Width="95%"  TextMode="MultiLine" CssClass="txtbox_Var"></asp:TextBox>
            </td>

            <!-- keep the image/upload cell in its own column if present -->
            <td style="width: 20%"></td>
        </tr>


        <tr>
            <td class="column_RightBold" style="width: 10%">Brand :</td>
            <td class="column_Left" style="width: 30%">
                <asp:Label ID="Label2" runat="server" Width="290px" SkinID="Label" Font-Italic="False"></asp:Label>
                <asp:TextBox ID="txtBrand" runat="server" Width="91%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
            </td>
        ...
        <tr>
            <td class="column_RightBold" style="width: 10%; padding-top:10px;">
                Specifications :
            </td>
            <td class="column_Left" colspan="3" style="padding-top:10px;">
                <asp:Label ID="lblSpecification" runat="server" CssClass="text3"></asp:Label>
                <asp:TextBox ID="txtSpecification" runat="server" Width="95%" Height="25px"
                    TextMode="MultiLine" AutoPostBack="True" CssClass="txtbox_Var" Rows="2"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="4">
                <fieldset style="width: 90%;">
                    ...
                    <table>
                        <tr>
                            <td class="column_RightBold" style="width: 121px"><span class="required-label">Acquisition Date :</span></td>
                        ...
                        <tr>
                            <td class="column_RightBold" style="width: 121px"><span class="required-label">Acquisition Cost :</span></td>
                            <td class="column_Left">
                        ...
                        <tr>
                            <td class="column_RightBold" style="width: 121px">Depreciated Rate :</td>
                            <td class="column_Left">
                                <asp:TextBox ID="txtVehicleDepRate" runat="server" Width="50px" AutoPostBack="True" CssClass="txtboxAmount" MaxLength="5"></asp:TextBox>&nbsp;(%) Percent
                            </td>
                            <td class="column_RightBold">Useful Life :</td>
                            <td class="column_Left">
                                <asp:Label ID="Label17" runat="server"></asp:Label>
                                <asp:TextBox ID="txtVehicleUsefullife" runat="server" Width="50px" AutoPostBack="True" Enabled="false" CssClass="txtbox_Var" onchange="return getDepValRate(this);"></asp:TextBox>
                                &nbsp;(Years)
                            </td>
                        </tr>
                        <tr>
                            <td class="column_RightBold" style="width: 121px">Depreciated Value :</td>
                            <td class="column_Left">
                            ...
                            <td class="column_Left">
                                <asp:TextBox ID="txtVehicleSalvageValue" runat="server" Width="140px" AutoPostBack="True" CssClass="txtboxAmount">0.00</asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                ...
                <fieldset style="width: 90%;">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td class="column_Left">
                                <asp:TextBox ID="TextBox18" runat="server"  AutoPostBack="True" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                            ...
                            <td class="column_Left">
                                <asp:TextBox ID="TextBox19" runat="server" AutoPostBack="True"  Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                            ...
                            <td class="column_Left">
                                <asp:TextBox ID="TextBox20" runat="server"  AutoPostBack="True" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="column_Left">
                                <asp:TextBox ID="TextBox21" AutoPostBack="True"  runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                            ...
                            <td class="column_Left">
                                <asp:TextBox ID="TextBox22"  AutoPostBack="True" runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                            ...
                            <td class="column_Left">
                                <asp:TextBox ID="TextBox23" AutoPostBack="True"  runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                            ...
                            <td class="column_Left">
                                <asp:TextBox ID="TextBox24"  AutoPostBack="True" runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="Button3" runat="server" Width="48%" CssClass="CSButton" Text="CANCEL" Enabled="false" OnClientClick="StartProgressBar();"></asp:Button>
            </td>
        </tr>
    </table>
</asp:View>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td class="column_Left" style="width: 30%">
                                                ...
                                                <asp:DropDownList ID="drpWatercraftName" CssClass="drpdownCSS"  AutoPostBack="true" runat="server" Width="91%" OnSelectedIndexChanged="drpWatercraftName_SelectedIndexChanged"></asp:DropDownList>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btnWatercraftsave" runat="server" Width="48%" CssClass="CSButton" Text="SAVE" Enabled="false" OnClientClick="StartProgressBar();" ></asp:Button>
                                        ...
                                        <tr>
                                            <td align="center" colspan="4">
                                                <asp:Panel ID="Panel1" runat="server" CssClass="PanelSize" ScrollBars="Vertical"
                                                    Width="100%">
                                                    <asp:GridView ID="grdLedger1" runat="server" Width="100%"  DataKeyNames="Property_ID" SkinID="GridViewAA" HorizontalAlign="Center" Font-Size="8pt" OnDataBound="OnDataBound" OnRowDataBound="grdLedger1_RowDataBound" >
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="DebitCost" DataFormatString="{0:N}" HeaderText="Unit Price" Visible ="false">
           ...
           <asp:Label ID="lblPropertyInfoTarget"
                runat="server"
                Style="display: none;">
            </asp:Label>
            ...
            <cc1:ModalPopupExtender ID="ModalPopupExtender2"
                runat="server"
                TargetControlID="lblPropertyInfoTarget"
                PopupControlID="popupParticular"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Weight">
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtWeight" runat="server" Width="75px"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <asp:Panel ID="popupAccess" runat="server" Width="350px" CssClass="Panel_Popup"   DefaultButton="Button2">
                <div>
                    <table width="100%">
                        <tr>
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <asp:Button ID="Button4" OnClick="Button4_Click" runat="server" Width="150px" CssClass="CSButton" CausesValidation="False"  Text="CANCEL"></asp:Button>
                            </td>
                        </tr>
                    </table>
                </div>
