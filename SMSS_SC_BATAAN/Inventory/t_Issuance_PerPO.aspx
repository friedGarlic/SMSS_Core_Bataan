<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="t_Issuance_PerPO.aspx.vb"
    Inherits="Inventory_t_Issuance_PerPO" Title="ISSUANCE PER PO" EnableEventValidation="false" StylesheetTheme="SkinFile" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <table width="100%">
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%" class="PageTitle">ISSUANCE PER PURCHASE ORDER
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 98%" align="center">
                            <table style="width: 970px; height: 100%" class="Text">
                                <tbody>
                                    <tr>
                                        <td style="height: 11px" align="center" colspan="3">
                    ...
                    <tr>
                        ...
                        <td style="width: 98%" align="center">
                            ...
                            &nbsp;<asp:Button ID="btnpreviewAreDoc" OnClick="btnpreviewAreDoc_Click" runat="server" Width="150px" CssClass="CSButton" Text="PREVIEW PARE" Enabled="False"></asp:Button>
                            &nbsp;<asp:Button ID="btnPreviewRIS" OnClick="btnPreviewRIS_Click" runat="server" Width="150px" CssClass="CSButton" Text="PREVIEW RIS" Enabled="False"></asp:Button>
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
