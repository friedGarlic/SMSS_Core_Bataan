...
#End Region
    ...
    Protected Sub btnsavedoc_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            objDerived.GetRecords("[AMS].[sp_Save_ARE_PerPO] '" & grdPOList.SelectedDataKey("Received_ID") & "','" & txtDateReceivedFrom.Text & "','" & ddByDepartment.SelectedValue & "','" & ddFromProperty.SelectedValue & "','" & ddByAcknowledgement.SelectedValue & "','" & txtMRE.Text & "'", CommandType.Text)
