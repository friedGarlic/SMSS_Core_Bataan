                    ...
                    <td colspan="7">
                        <table>
                            ...
                            <tr style="display:none;">
                                ...
                                <td>
                                    <asp:DropDownList ID="ddClass" runat="server" CssClass="drpdownCSS"
                                        Width="200px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        ...
                                        <asp:DropDownList ID="drpName"  CssClass="drpdownCSS" AutoPostBack="true" runat="server" Width="91%" OnSelectedIndexChanged="drpName_SelectedIndexChanged"></asp:DropDownList>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        ...
                                        <asp:DropDownList ID="drpUnit" runat="server" Width="100px" Enabled="false"  ></asp:DropDownList>
                                        ...
                                        <span class="column_RightBold required-label">Quantity :</span>
                                         <asp:TextBox ID="txtQuantity" AutoPostBack="true"  runat="server" Width="100px" CssClass="txtbox_Var"  ></asp:TextBox>
                                    ...
                                    <td align="center" rowspan="6" style="width: 20%;border:2px solid #808080" valign="top" >
                                        ...
                                        <br />
                                               <asp:Button ID="btnupload" runat="server" Width="48%" CssClass="CSButton" Text="UPLOAD" Enabled="false" OnClientClick="StartProgressBar();"></asp:Button>
                                
                                    </td>
                                </tr>
                                <tr>
                                    <td class="column_RightBold" style="width: 11%"><span class="required-label">Description :</span></td>
                                    <td class="column_Left" style="width: 30%">
                                        <asp:Label ID="lblequipmentdesciption" runat="server" Width="290px" SkinID="Label" Font-Italic="False" Visible="false"></asp:Label>
                                        <asp:TextBox ID="txtequipmentdesciption" AutoPostBack="true"  runat="server" Width="89%" CssClass="txtbox_Var"  ></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        <asp:TextBox ID="txtequipmentwaranty"  AutoPostBack="true" runat="server" CssClass="txtbox_Var" Width="89%"></asp:TextBox>
                                ...
                                <tr>
                                     ...
                                     <td class="column_RightBold" style="width: 11%">Brand :

                                    </td>
                                    <td class="column_Left" style="width: 30%">
                                        <asp:Label ID="Label6" runat="server" Width="290px" SkinID="Label" Font-Italic="False" Visible="false"></asp:Label>
                                        <asp:TextBox ID="txtBrand" AutoPostBack="true"  runat="server" Width="89%" CssClass="txtbox_Var"></asp:TextBox>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                      ...
                                      <tr>
                                          ...
                                          <td class="column_RightBold" style="width: 11%">&nbsp;Remarks : </td>
                                    <td class="column_Left" style="width: 30%">
                                      <%--  <asp:Label ID="lblequipmentwaranty" runat="server" Font-Italic="False" SkinID="Label" Width="290px"></asp:Label>--%>
                                         <asp:TextBox ID="txtRemarks" runat="server" Width="89%" CssClass="txtbox_Var" AutoPostBack="true" 
                                 ...
                                 <tr >
                                    <td class="column_RightBold" style="width: 11%;">Specifications :
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        ...
                                        <asp:TextBox ID="txtequipmentpowerinput" AutoPostBack="true"  runat="server" CssClass="txtbox_Var" Visible="false" Width="89%"></asp:TextBox>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        <asp:TextBox ID="txtequipmentSerialNumber"  AutoPostBack="true" runat="server" CssClass="txtbox_Var" Visible="false"></asp:TextBox>
                                ...
                                <tr>
                                    <td colspan ="4">
                                        ...
                                        <table >
 <tr>
                                     <td  class="column_RightBold"><span class="required-label">Acquisition Date :</span></td>
                                    <td class="column_Left" style="width:100px;">
                                        <asp:Label ID="Label1" runat="server"></asp:Label>
                                        <asp:TextBox ID="txtEAcqDate" runat="server" AutoPostBack="true"  CssClass="txtbox_Var" onchange="return NoOfYears(this.value);" Width="140px"  ></asp:TextBox>
                                   ...
                                   <td class="column_RightBold" >Market Value :
                                    ...
                                    <td class="column_Left" >
                                        ...
                                        <asp:TextBox ID="txtEMarketValue" AutoPostBack="true"  runat="server" CssClass="txtboxAmount" Width="140px" Onkeyup="javascript:this.value=Comma(this.value);" Onchange="this.value=formatCurrency(this.value);"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="column_Left" >
                                        ...
                                        <asp:TextBox ID="txtNoYears" runat="server" AutoPostBack="True" CssClass="txtbox_Var" Width="50px" onchange="return getDepValRate(this)"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="column_Left" >
                                        ...
                                        <asp:TextBox ID="txtequipmentdepreciatedvalue" runat="server"  AutoPostBack="True" CssClass="txtboxAmount" Width="140px" Onkeypress="javascript:this.value=Comma(this.value);" Onchange="this.value=formatCurrency(this.value);"></asp:TextBox>
                                    </td>
                                    
                                   <td class="column_RightBold">Salvage Value :
                                    </td>
                                    <td class="column_Left" >
                                        <asp:TextBox ID="txtSalvageValue"  AutoPostBack="true" runat="server" CssClass="txtboxAmount" Width="140px" >0.00</asp:TextBox></td>
                                        ...
                                        <tr>
                                            <td align="center" colspan="4">
                                                <asp:Panel ID="Panel1" runat="server" CssClass="PanelSize" ScrollBars="Vertical"
                                                    Width="100%">
                                                    <asp:GridView ID="grdLedger1" runat="server" Width="100%" SkinID="GridViewAA" OnPageIndexChanging="grdLedger1_PageIndexChanging" DataKeyNames="Ledger_ID,Property_ID" HorizontalAlign="Center" Font-Size="8pt" OnDataBound = "OnDataBound" OnRowDataBound="grdLedger1_RowDataBound">
                            ...
                            EmptyDataText="No records has been added." OnRowDataBound="grdPropertyInfo_RowDataBound"
                                ...
                                <Columns>
                                      ...
                                      <asp:TemplateField HeaderText="Serial No." >
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtSerialNumber" runat ="server" Width ="200px"  
                                                AutoPostBack="true" OnTextChanged="txtSerialNoOfEquip_TextChanged"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField ItemStyle-Width ="19%" HeaderText="Installed At" >
                                        ...
                                        <asp:DropDownList ID="drpInstalledAtFurNiture"
                                        runat="server"
                                        Width="150px"
                                        AutoPostBack="true"
                                        OnSelectedIndexChanged="drpInstalledAtFurNiture_SelectedIndexChanged" />
