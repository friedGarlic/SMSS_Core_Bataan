<%@ Page Language="VB"
    ...
    CodeFile="t_LGU_to_LGU_V2.aspx.vb"
    EnableEventValidation="false" 
    Inherits="t_LGU_to_LGU_V2" 
        ...
        <ContentTemplate>
            ...
            <div>
                <table width="100%">
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%" class="PageTitle">L.G.U TO L.G.U
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
                            ...
                            <asp:MultiView ID="mvIssuance" runat="server">
                                ...
                                <asp:View ID="vwARE" runat="server">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td style="width: 100%" align="center">
                                                <asp:GridView ID="grListOfProperty" runat="server" Width="98%" SkinID="GridViewAA" DataKeyNames="status,PropertyNo,Rc_name,rc_id,function_id,MREHdr_ID,Property_ID,PropertyDetai_ID,Item_Desc,Item_ID,MREDtl_ID,Cost,SerialNo,isVisible"
                                                    AllowPaging="True" HorizontalAlign="Center">
                                                    <Columns>
                                                        <asp:TemplateField HeaderStyle-Width="15px" ItemStyle-Width="15px">
                                                          <%--  <ItemTemplate>
                                                              ...
                                                              <HeaderTemplate>
                                                                  <asp:CheckBox ID="CheckBox21" runat="server" Font-Bold="true" ForeColor="White" Font-Size="10pt" Font-Names="tahoma" AutoPostBack="true" Text="All" OnCheckedChanged="CheckBox21_CheckedChanged"></asp:CheckBox>
                                                              </HeaderTemplate>
                                                              <ItemTemplate>
                                                        ...
                                                        <asp:BoundField DataField="fullname" HeaderText="Donate To">
                                                            <HeaderStyle Font-Size="Smaller"></HeaderStyle>

                                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="DateIssued" DataFormatString="{0:d}" HeaderText="Date Donate">
                                                            <HeaderStyle Font-Size="Smaller"></HeaderStyle>

                                                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="MRE_Date" DataFormatString="{0:d}" HeaderText="Date Returned / Disposed" Visible="false">
                                                            <HeaderStyle Font-Size="Smaller"></HeaderStyle>
                                        ...
                                        <tr>
                                            <td style="width: 100%" align="center">
                                                ...
                                                &nbsp;<asp:Button ID="btnPropNo" OnClick="btnPropNo_Click" runat="server" CssClass="CSButton" Width="150px" Text="EDIT PROPERTY NO." Visible="false"></asp:Button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 100%" align="center">
                                                <asp:HiddenField ID="HiddenField1" runat="server"></asp:HiddenField>
                                                <asp:HiddenField ID="hndLGUHrd_ID" runat="server"></asp:HiddenField>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width: 100%" align="center">
                                                <table style="width: 90%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 15%" class="column_RightBold">L.G.U/Department :</td>
                                                        <td style="width: 35%" class="column_Left">
                                                            ...
                                                            <asp:TextBox ID="txtDepartment" runat="server" CssClass="txtbox_Var" Width="300px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="width: 35%" class="column_Left">
                                                            ...
                                                            <asp:TextBox ID="txtIssueTo" runat="server" CssClass="txtbox_Var" Width="300px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        ...
                                                        <td class="column_Left">
                                                            <asp:TextBox ID="txtReceivedPostion" runat="server" CssClass="txtbox_Var" Width="300px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tr>
                                            <td style="width: 100%" align="center">
                                                ...
                                                &nbsp;<asp:Button ID="btncancelDoc" OnClick="btncancelDoc_Click" runat="server" CssClass="CSButton" Width="150px" Text="CANCEL" Enabled="False" Visible="false"></asp:Button>
                                                &nbsp;<asp:Button ID="btnpreviewAreDoc" OnClick="btnpreviewAreDoc_Click" runat="server" CssClass="CSButton" Width="150px" Text="PREVIEW" Enabled="False"></asp:Button>
                                    ...
                                    <asp:Panel ID="Panel4" runat="server" Width="400px" Font-Bold="True" BorderWidth="2px" BorderStyle="Solid" Height="150px" BorderColor="Gray" BackImageUrl="~/images/modalpopup_04.png">
                                        <table>
                                            <tbody>
                                                <tr>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Width="400px" Font-Bold="True" BorderWidth="2px" BorderStyle="Solid" Height="150px" BorderColor="Gray" BackImageUrl="~/images/modalpopup_04.png">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="width: 400px" align="center">
                                                        <asp:Button ID="btnSaveProp" OnClick="btnSaveProp_Click" runat="server" Width="150px" Text="OK" OnClientClick="StartProgressBar();"></asp:Button>
                                                        <asp:Button ID="btnCancel" runat="server" Width="150px" Text="CANCEL"></asp:Button></td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 400px" align="center"></td>
                                                </tr>
