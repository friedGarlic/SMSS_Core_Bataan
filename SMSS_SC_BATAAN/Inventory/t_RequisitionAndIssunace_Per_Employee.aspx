<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="t_RequisitionAndIssunace_Per_Employee.aspx.vb"
        ...
        <ContentTemplate>
            ...
            <div>
                <table width="100%">
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%" class="PageTitle">ISSUANCE OF DEPARTMENT</td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
                        <td style="width: 1%"></td>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="width: 100%" align="center">
                                                    <span class="column_RightBold">Department :</span>
                                                                &nbsp;<asp:DropDownList runat="server" ID="drpSearh_Department" CssClass="drpdownCSS" Width="30%" AutoPostBack="true" OnSelectedIndexChanged="drpSearh_Department_SelectedIndexChanged"></asp:DropDownList>&nbsp;
                                                    ...
                                                    &nbsp;<asp:Button runat="server" ID="btnView_Supplies" CssClass="CSButton" Width="12%" Text="View" OnClientClick="StartProgressBar();" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr align="center">
                                                <td>
                                                    ...
                                                    <table width="95%">
                                                        <tr>
                                                            <td class="column_LeftBold"></td>
                                                            <td class="column_LeftBold">Warehouse</td>
                                                            <td class="column_LeftBold">Bay</td>
                                                            <td class="column_LeftBold">Column</td>
                                                            <td class="column_LeftBold">Floor</td>
                                                            <td class="column_LeftBold"></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="column_LeftBold"></td>
                                                            <td class="column_Left">
                                                                <asp:DropDownList ID="drpRIS_Warehouse" runat="server" AutoPostBack="true" CssClass="drpdownCSS" Enabled="true" Width="95%">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="column_Left">
                                                                <asp:DropDownList ID="drpBay" runat="server" AutoPostBack="true" CssClass="drpdownCSS" Enabled="true" Width="95%">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="column_Left">
                                                                <asp:DropDownList ID="drpColumn" runat="server" AutoPostBack="true" CssClass="drpdownCSS" Enabled="true" Width="95%">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="column_Left">
                                                                <asp:DropDownList ID="drpRIS_Floor" runat="server" AutoPostBack="true" CssClass="drpdownCSS" Enabled="true" Width="95%">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="column_LeftBold"></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="column_LeftBold"></td>
                                                            <td class="column_LeftBold">Room</td>
                                                            <td class="column_LeftBold">Shelves</td>
                                                            <td class="column_LeftBold">Rack</td>
                                                            <td class="column_LeftBold">Bin</td>
                                                            <td class="column_LeftBold"></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="column_LeftBold"></td>
                                                            <td class="column_Left">
                                                                <asp:DropDownList ID="drpRIS_Room" runat="server" AutoPostBack="true" CssClass="drpdownCSS" Enabled="true" Width="95%">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="column_Left">
                                                                <asp:DropDownList ID="drpRIS_Shelves" runat="server" AutoPostBack="true" CssClass="drpdownCSS" Enabled="true" Width="95%">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="column_Left">
                                                                <asp:DropDownList ID="drpRack" runat="server" AutoPostBack="true" CssClass="drpdownCSS" Enabled="true" Width="95%">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="column_Left">
                                                                <asp:DropDownList ID="drpBin" runat="server" AutoPostBack="true" CssClass="drpdownCSS" Enabled="true" Width="95%">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="column_LeftBold"></td>
                                                        </tr>
                                            ...
                                            <tr align="center">
                                                ...
                                                <td >
                                                                    ...
                                                                    <asp:DropDownList runat="server" ID="drpSeachDepartment" CssClass="drpdownCSS" Width="25%" Visible="false"></asp:DropDownList>

                                                                    <asp:Button ID="btnSupplySearch" OnClick="btnSupplySearch_Click" runat="server" CssClass="CSButton" Width="150px" Text="SEARCH" OnClientClick="StartProgressBar();"></asp:Button>
                                            ...
                                            <tr>
                                                <td style="width: 100%" align="center">
                                                    <asp:GridView ID="gvSupplyList" runat="server" Width="95%" Font-Size="8pt" CssClass="text" SkinID="GridViewAA"
                                                        OnSelectedIndexChanged="gvSupplyList_SelectedIndexChanged" DataKeyNames="Item_Code,ItemDesc,UnitDesc,Balance,Cost,ID,Item_ID,GA_ID,RC_ID,Function_ID,StockID,Barcode_Supplies" AllowPaging="True"
                                                        ...
                                                        <Columns>
                                                           <%-- <asp:BoundField DataField="Item_Code" HeaderText="Item Code">
                                                            ...
                                                            <asp:BoundField DataField="RC_ID" HeaderText="RC_ID"></asp:BoundField>--%>
                                                             ...
                                                             <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:CheckBox runat="server" ID="cbRISItem" AutoPostBack="true" Checked='<%# Bind("isChecked") %>' Visible='<%# Bind("isVisible") %>' OnCheckedChanged="cbRISItem_CheckedChanged"/>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Description">
                                                                <ItemTemplate>
                                                                    <asp:Label runat="server" ID="lblRIS_ItemDesc" ToolTip='<%# Bind("RC_Name") %>' Text='<%# Bind("ItemDesc") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:BoundField DataField="Balance" HeaderText="Available Qty" DataFormatString="{0:#,##0.##}">
                                                                <ItemStyle HorizontalAlign="Center" Width="8%"></ItemStyle>
                                                            </asp:BoundField>

                                                            <asp:BoundField DataField="wLocation" HeaderText="Location">
                                                            ...
                                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="15%" HeaderText="Barcode">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton runat="server" ID="lnkBarcode_Supplies" CssClass="LinkBtnSelect" Text='<%# Bind("Barcode_Supplies") %>' CommandName="Select" OnClientClick="StartProgressBar();"></asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                            ...
                                            <tr>
                                                <td style="width: 100%" align="center">
                                                    <table style="width: 100%">
                                                        <tbody>
                                                            <tr>
                                                                <td style="width: 10%" class="column_RightBold">&nbsp;<span class="column_RightBold">Date :</span></td>
                                                                <td class="column_Left">&nbsp;<asp:TextBox ID="txtdate" runat="server" Width="100px" CssClass="txtbox_Date" AutoPostBack="true" OnTextChanged="txtdate_TextChanged"></asp:TextBox>
                                                                ...
                                                                <td class="column_RightBold">Issued By :</td>
                                                                <td style="width: 40%" class="column_Left">
                                                              
                                                                
                                                                    <asp:DropDownList ID="ddIssuedby" runat="server" AutoPostBack="True" CssClass="drpdownCSS" OnSelectedIndexChanged="ddIssuedby_SelectedIndexChanged" Width="60%">
                                                                    </asp:DropDownList>
                                                            ...
                                                            <tr>
                                                                <td style="width: 10%; height: 21px;" class="column_RightBold">Ref. Number :</td>
                                                                <td style="width: 40%; height: 21px;" class="column_Left">
                                                                    <asp:TextBox ID="txtCategoryCode" runat="server" CssClass="txtbox_Var" Visible="false" Width="40px"></asp:TextBox>
                                                                    <asp:DropDownList ID="drpCategoryCode" runat="server" CssClass="drpdownCSS" Width="50px" Visible="false">
                                                                        <asp:ListItem Text="OTS" Value="1"></asp:ListItem>
                                                                        <asp:ListItem Text="OS" Value="2"></asp:ListItem>
                                                                        <asp:ListItem Text="JS" Value="3"></asp:ListItem>
                                                                        <asp:ListItem Text="MS" Value="4"></asp:ListItem>
                                                                        <asp:ListItem Text="DS" Value="5"></asp:ListItem>
                                                                        <asp:ListItem Text="LS" Value="6"></asp:ListItem>
                                                                        <asp:ListItem Text="MDS" Value="7"></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                    <asp:TextBox ID="txtRIS" runat="server" CssClass="txtbox_Var"  Width="100px"></asp:TextBox>
                                                                </td>
                                                                <td class="column_RightBold">Approved By :</td>
                                                                <td class="column_Left">
                                                                    <asp:DropDownList ID="drpApprovedBy" runat="server" CssClass="drpdownCSS" style="margin-bottom: 0px" Width="60%">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 10%" class="column_RightBold">Received By :</td>
                                                                <td style="width: 40%" class="column_Left">
                                                                    <asp:TextBox ID="txtReceivedBy" runat="server" Width="200px" CssClass="txtbox_Var"></asp:TextBox>
                                                                </td>
                                                                <td style="width: 10%" class="column_RightBold">Purpose :</td>
                                                                <td style="width: 40%" class="column_Left">
                                                                    <asp:TextBox ID="txtremarks" runat="server" CssClass="txtbox_Var" SkinID="text" Width="60%"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                <td style="width: 100%;display:none" align="center">
                                                            ...
                                                            <asp:Panel ID="Panel2" runat="server" Width="98%" Font-Bold="True" CssClass="PanelSize" BorderStyle="Solid" BorderColor="Silver" BorderWidth="1px" HorizontalAlign="Center" ScrollBars="Vertical">
                                                                <asp:GridView ID="gvbody" runat="server" Width="100%" SkinID="GridViewAA" EmptyDataText="No Data Found." AutoGenerateColumns="False" PageSize="20" ShowFooter="True">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="Balance" HeaderText="Available Qty" DataFormatString="{0:#,###.##}">
                                                                            <ItemStyle HorizontalAlign="Center" Width="10%"></ItemStyle>
                                                                        </asp:BoundField>

                                                                        <asp:TemplateField HeaderText="Quantity">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtqty" runat="server" Width="90%" Text='<%# Bind("issuance", "{0:#,##0.##}") %>' CssClass="txtbox_Date" AutoPostBack="True" OnTextChanged="txtqty_TextChanged1"></asp:TextBox>
                                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtqty" ValidChars="0123456789.,"></cc1:FilteredTextBoxExtender>
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" Width="10%"></ItemStyle>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Remarks">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtRemarks" runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" Width="20%"></ItemStyle>
                                                                        </asp:TemplateField>
                                            ...
                                            <tr>
                                                <td style="width: 100%" align="center">
                                                    <asp:Button runat="server" ID="btnCopyValues" Width="150px" CssClass="CSButton" Text="Copy All Values" Visible="false" OnClientClick="StartProgressBar();" />
                                                    ...
                                                    &nbsp;<asp:Button ID="btnpreview" runat="server" CssClass="CSButton" Width="150px" CausesValidation="False" Text="PREVIEW RIS" Enabled="False" SkinID="ButtonImage" Visible="false"></asp:Button>
                                                    &nbsp;<asp:Button ID="btnPreviewICS" OnClick="btnPreviewICS_Click" runat="server" CssClass="CSButton" CausesValidation="False" Text="PREVIEW ICS" Enabled="False" SkinID="ButtonImage" Visible="false"></asp:Button>

                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="grdLedger" runat="server" Width="980px" SkinID="GridViewAA" Font-Size="8pt" >
                                                        <Columns>
                                                            <asp:BoundField DataField="tDate" DataFormatString="{0:d}" HeaderText="Date">
                                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="5%" ></ItemStyle>
                                                            </asp:BoundField>
                                                         
                                                            <asp:BoundField DataField="Item_Desc"  HeaderText="Particular">
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="50%" ></ItemStyle>
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="Cost" HeaderText="Cost" DataFormatString="{0:N}">
                                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" ></ItemStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="Total" HeaderText="Total Cost" DataFormatString="{0:N}">
                                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" ></ItemStyle>
                                                            </asp:BoundField>
