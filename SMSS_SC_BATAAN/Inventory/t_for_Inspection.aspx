<%@ Page Language="VB"
    ...
    CodeFile="t_for_Inspection.aspx.vb"
    Inherits="Inventory_t_for_Inspection"
                ...
                <table width="100%">
                    <tr>
                        <td class="PageTitle" style="width: 98%">
                            <strong>
                                <asp:Label ID="lblClass" runat="server" Text="For Inspection"></asp:Label>
                            </strong>
                        </td>
                    </tr>
                    <tr>
                                                    ...
                                                    <table id="tb_PO" runat="server" style="width: 100%">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="width: 80%">
                                                                    <asp:TextBox ID="txtSearchPO" runat="server" placeholder="Enter PO Number"></asp:TextBox>
                                                                    <asp:Button ID="btnSearchPO" runat="server" Text="Search" OnClick="btnSearchPO_Click" />
                    ...
                    <tr>
                        <td class="DivTitle" style="width: 98%; height: 26px;">
                            <strong>
                                <asp:Label ID="Label1" runat="server" Text="For Inspection"></asp:Label>
                            </strong>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="DivTitle" style="width: 98%; height: 26px;">
                            <strong>
                                <asp:Label ID="Label2" runat="server" Text="Item Detail"></asp:Label>
                            </strong>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="DivTitle" style="width: 98%; height: 26px;">
                            <strong>
                                <asp:Label ID="Label3" runat="server" Text="Inspection"></asp:Label>
                            </strong>
                        </td>
                    </tr>
                    <tr align="center">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="column_Left" style="width: 250px">
                                        <asp:TextBox ID="txtDate" runat="server" CssClass="txtbox_Var"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="column_Left">
                                        <asp:DropDownList ID="ddInspection1" CssClass="drpdownCSS" runat="server" Width="200px">
                                            <asp:ListItem Value="0">Select</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td class="column_RightBold">Inspector 2 : &nbsp;</td>

                                    <td class="column_Left">
                                        <asp:DropDownList ID="ddInspection2" CssClass="drpdownCSS" runat="server" Width="200px">
                                            <asp:ListItem Value="0">Select</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                    ...
                    <tr align="center" style="height: 100px">
                        <td>
                            <table>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnSave" runat="server" CssClass="CSButton" Width="150px" OnClientClick="StartProgressBar();" Enabled="false" Text="Save" OnClick="btnSave_Click" />

                                    </td>
                                    <td>
                                        <asp:Button ID="btnPreview" runat="server" CssClass="CSButton" Width="150px" Text="Preview" OnClick="btnPreview_Click" Enabled="False" /></td>
                                </tr>
                            </table>
                        </td>
