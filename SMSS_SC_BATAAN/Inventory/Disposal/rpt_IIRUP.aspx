...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function PrintReport() {
            ...
            frame.src = "rpt_IIRUP.aspx?print=1&t=" + new Date().getTime();
        }
    </script>
    ...
    <div>
        <table width="1020px" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 1%"></td>
                <td style="width: 98%" class="PageTitle">INVENTORY AND INSPECTION REPORT OF UNSERVICEABLE PROPERTY</td>
                <td style="width: 1%"></td>
            </tr>
            <tr>
                <td style="width: 1%"></td>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td style="width: 100%" align="center">
                                    <CR:CrystalReportViewer ID="Disposal_Reports" runat="server"
                                        AutoDataBind="true"
