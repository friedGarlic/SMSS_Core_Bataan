...
Partial Class Inventory_Disposal_Disposal_Abstract
    ...
    Protected Sub LoadSignatories()
        drpMember1.DataSource = objDerived.GetDataTable("SELECT A.BACDispose_ID, B.Full_Name, B.position_desc, B.EmpID FROM AMS.BAC_DisposalCommittee AS A RIGHT OUTER JOIN " &
                                                        " HRMS.view_signatory AS B ON A.EmpID = B.EmpID WHERE (B.isActive = 1) ORDER BY B.Full_Name", CommandType.Text)
        drpMember1.DataTextField = "Full_Name"
        drpMember1.DataValueField = "EmpID"
        drpMember1.DataBind()
        drpMember1.Items.Insert(0, "Select")

        drpMember2.DataSource = objDerived.GetDataTable("SELECT A.BACDispose_ID, B.Full_Name, B.position_desc, B.EmpID FROM AMS.BAC_DisposalCommittee AS A RIGHT OUTER JOIN " &
                                                        " HRMS.view_signatory AS B ON A.EmpID = B.EmpID WHERE (B.isActive = 1) ORDER BY B.Full_Name", CommandType.Text)
        ...
        drpMember3.DataSource = objDerived.GetDataTable("SELECT A.BACDispose_ID, B.Full_Name, B.position_desc, B.EmpID FROM AMS.BAC_DisposalCommittee AS A RIGHT OUTER JOIN " &
                                                        " HRMS.view_signatory AS B ON A.EmpID = B.EmpID WHERE (B.isActive = 1) ORDER BY B.Full_Name", CommandType.Text)
        ...
        drpMember4.DataSource = objDerived.GetDataTable("SELECT A.BACDispose_ID, B.Full_Name, B.position_desc, B.EmpID FROM AMS.BAC_DisposalCommittee AS A RIGHT OUTER JOIN " &
                                                        " HRMS.view_signatory AS B ON A.EmpID = B.EmpID WHERE (B.isActive = 1) ORDER BY B.Full_Name", CommandType.Text)
        ...
        drpMember5.DataSource = objDerived.GetDataTable("SELECT A.BACDispose_ID, B.Full_Name, B.position_desc, B.EmpID FROM AMS.BAC_DisposalCommittee AS A RIGHT OUTER JOIN " &
                                                        " HRMS.view_signatory AS B ON A.EmpID = B.EmpID WHERE (B.isActive = 1) ORDER BY B.Full_Name", CommandType.Text)
