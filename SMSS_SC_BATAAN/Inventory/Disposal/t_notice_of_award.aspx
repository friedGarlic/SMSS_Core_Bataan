<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="t_notice_of_award.aspx.vb" Inherits="t_notice_of_award" StylesheetTheme="SkinFile" Title="Notice Of Award" %>
            ...
            <table style="width: 1010px">
                <tbody>
                    <tr>
                        ...
                        <td style="width: 1000px" class="PageTitle" align="center">NOTICE OF AWARD</td>
                    </tr>
                    <tr>
                        <td style="width: 10px"></td>
                                ...
                                <asp:View ID="vwProperty" runat="server" __designer:wfdid="w69">
                                    <table style="width: 100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width: 100%" align="center">
                                                    <asp:Button ID="btnSave" runat="server" Width="200px" __designer:wfdid="w78" SkinID="ButtonImage" Text="AWARD" Enabled="False" OnClientClick="StartProgressBar();" ValidationGroup="1"></asp:Button><asp:Button ID="btnPreview" runat="server" Width="200px" __designer:wfdid="w79" SkinID="ButtonImage" Text="PREVIEW" Enabled="False" OnClientClick="StartProgressBar();"></asp:Button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </asp:View>
