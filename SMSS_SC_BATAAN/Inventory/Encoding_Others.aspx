...
<%@ Page Title="Encoding of Others" Language="VB" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="false" CodeFile="Encoding_Others.aspx.vb" Inherits="Inventory_Encoding_Others"
...
function NoOfYears(dateString) {
    ...
    if (m < 0 || (m === 0 && today.getDate() < birthDate.getDate())) {
     ...
     function getDepValRate(Integer) {
        ...
        document.getElementById("ctl00_ContentPlaceHolder1_txtothersdepreciatedvalue").value = (DepreciatedValue).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
        //End Depreciated
                ...
                <table style="width: 100%;">
                    ...
                    <tr style="display: none;">
                        <td align="center" style="width: 100%">
                            ...
                            &nbsp;<asp:TextBox ID="txtSerialSearch"  AutoPostBack="true" runat="server" Width="200px" CssClass="txtbox_Var"></asp:TextBox>
                                 ...
                                 <table style="width: 100%;">
                                     <tr>
                                         ...
                                         <td class="column_Left" style="width: 25%">
                                             ...
                                             <asp:TextBox ID="txtothersQuantity"  AutoPostBack="true" runat="server" Width="100px" CssClass="txtbox_Var"  ></asp:TextBox>
                                     ...
                                     <tr>
                                         ...
                                         <td class="column_Left" style="width: 30%">
                                             ...
                                             <asp:TextBox ID="txtothersdesciption" runat="server" Width="89%" AutoPostBack="True" CssClass="txtbox_Var"  ></asp:TextBox>
                                         ...
                                         <td class="column_Left" style="width: 30%">
                                             ...
                                             <asp:TextBox ID="txtotherswaranty" runat="server" Width="89%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
                                     ...
                                     <tr>
                                         ...
                                         <td class="column_Left" style="width: 30%">
                                             ...
                                             <asp:TextBox ID="txtotherspowerinput" runat="server" Width="89%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
                                         ...
                                         <td class="column_Left">
                                             ...
                                             <asp:TextBox ID="txtothersdimension" runat="server" AutoPostBack="True" CssClass="txtbox_Var" Width="89%"></asp:TextBox>
                                         ...
                                         <td class="column_Left" style="width: 30%; display: none;">
                                             ...
                                             <asp:TextBox ID="txtothersareacapacity" runat="server" Width="89%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
                                         </td>
                                     </tr>
                                     <tr>
                                          <td class="column_RightBold" style="width: 10%">Brand :
                                         </td>
                                         <td class="column_Left" style="width: 30%">
                                             <asp:Label ID="Label22" runat="server" Width="290px" SkinID="Label" Font-Italic="False"></asp:Label>
                                             <asp:TextBox ID="txtothersBrand" runat="server" Width="89%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
                                         ...
                                         <td class="column_Left" style="width: 30%">
                                             ...
                                             <asp:TextBox ID="txtothersmodel" runat="server" Width="89%" AutoPostBack="True" CssClass="txtbox_Var"></asp:TextBox>
                                     ...
                                     <tr> 
                                         ...
                                         <td class="column_RightBold" style="width: 10%"><span class="required-label">Remarks :</span>
                                         </td>
                                         <td class="column_Left" style="width: 30%">
                                             <asp:Label ID="Label21" runat="server" Width="290px" SkinID="Label" Font-Italic="False"></asp:Label>
                                         ...
                                         <td class="column_Left" style="width: 30%">
                                             <asp:LinkButton ID="Linkbutton1" runat="server" OnClick="btnaddpropertyinfo_Click" ><span class="required-label">Add Property Information </span> </asp:LinkButton>
                                         </td>

                                         <td class="column_RightBold" style="width: 10%">&nbsp;</td>
                                         <td class="column_Left" style="width: 30%">
                                             <asp:Label ID="Label20" runat="server" Width="290px" SkinID="Label" Font-Italic="False" Visible="false"></asp:Label>
                                             <asp:TextBox ID="txtothersSerialNo" runat="server" Width="89%" AutoPostBack="True" CssClass="txtbox_Var" Visible="false"></asp:TextBox>
                                         </td>
                                         <td></td>
                                         <td class="column_Left">
                                                 ...
                                                 <table>
                                                     <tr>
                                                         ...
                                                         <td class="column_Left">
                                                             ...
                                                             <asp:TextBox ID="txtEMarketValue" AutoPostBack="true"  runat="server" Width="140px" CssClass="txtboxAmount" Onkeyup="javascript:this.value=Comma(this.value);" Onchange="this.value=formatCurrency(this.value);"></asp:TextBox>
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td class="column_Left">
                                                             ...
                                                             <asp:TextBox ID="txtDepreciatedRate" AutoPostBack="true"  runat="server"  CssClass="txtboxAmount" Width="50px" MaxLength="5"></asp:TextBox>&nbsp;(%) Percent
                                                        </td>
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td class="column_Left">
                                                             ...
                                                             <asp:TextBox ID="txtothersdepreciatedvalue"  runat="server" AutoPostBack="True" Width="140px" CssClass="txtboxAmount"></asp:TextBox>
                                                         </td>
                                             ...
                                             <fieldset style="width: 90%;">
                                                 ...
                                                 <table width="100%">
                                                     <tr>
                                                         ...
                                                         <td class="column_Left">
                                                             <asp:TextBox ID="txtothersBay"  AutoPostBack="true" runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                                                         ...
                                                         <td class="column_Left">
                                                             <asp:TextBox ID="txtothersColumn" AutoPostBack="true"  runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                                                         ...
                                                         <td class="column_Left">
                                                             <asp:TextBox ID="txtothersFloor"  AutoPostBack="true" runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td class="column_Left">
                                                             <asp:TextBox ID="txtothersRoom" AutoPostBack="true"  runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                                                         ...
                                                         <td class="column_Left">
                                                             <asp:TextBox ID="txtothersShelves" AutoPostBack="true"  runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                                                         ...
                                                         <td class="column_Left">
                                                             <asp:TextBox ID="txtothersRack" AutoPostBack="true"  runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
                                                         ...
                                                         <td class="column_Left">
                                                             <asp:TextBox ID="txtothersBin" AutoPostBack="true"  runat="server" Width="90%" CssClass="txtbox_Var"></asp:TextBox>
 ...
 <tr>
                                        ...
                                        <tr>
                                            <td align="center" colspan="4">
                                                <asp:Panel ID="Panel1" runat="server" CssClass="PanelSize" ScrollBars="Vertical"
                                                    Width="100%">
                                                    <asp:GridView ID="grdLedger1" runat="server" Width="100%" SkinID="GridViewAA" HorizontalAlign="Center" Font-Size="8pt" OnDataBound = "OnDataBound"   DataKeyNames="Ledger_ID,Property_ID" OnRowDataBound="grdLedger1_RowDataBound">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:HiddenField ID="hfLedgerId" runat="server" Value='<%# Eval("Ledger_ID") %>' />
                                                                    <asp:HiddenField ID="hfPropertyId" runat="server" Value='<%# Eval("Property_ID") %>' />
                                                            ...
                                                            <asp:BoundField DataField="Cost" DataFormatString="{0:N}" HeaderText="Unit Price" Visible ="false">
    ...
    <ItemTemplate>
        <asp:DropDownList ID="drpInstalledAtEquip" 
            runat="server" 
            Width="150px" 
            OnSelectedIndexChanged="drpInstalledAtMac_SelectedIndexChanged" 
            AutoPostBack="true" />
    </ItemTemplate>
</asp:TemplateField>
