                ...
                <table width="100%">
                     <tr>
                        <td colspan="7" class="PageTitle" style="width: 98%">
                            <%--STOCK CARD--%><strong>
                                <asp:Label ID="lblClass" runat="server" Text="ENCODING OF ROADS AND BRIDGES CONSTRUCTION"></asp:Label>
                            </strong>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="7" class="DivTitle" style="width: 100%">
                            ROADS AND BRIDGES CONSTRUCTION INFORMATION 
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <td class="column_Left" >
                                        <asp:TextBox ID="txtRoadSalvageValue" runat="server" Width="85%" CssClass="txtbox_Var" >0.00</asp:TextBox></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="column_Left"><asp:TextBox ID="txtDepreciationRoad" runat="server" CssClass="txtboxAmount" Width="140px"></asp:TextBox></td>
                                                                <td></td>
                                                                <td></td>
                                                            </tr>
