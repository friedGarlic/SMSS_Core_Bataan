<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="t_RequisitionAndIssunace_V2.aspx.vb"
                                            ...
                                            <tr>
                                                <td style="width: 100%" align="center">
                                                    <table style="width: 100%">
                                                        <tbody>
                                                            <tr>
                                                                <td style="width: 10%" class="column_RightBold">&nbsp;<span class="column_RightBold">RIS Date :</span></td>
                                                                ...
                                                                <td class="column_RightBold">SAI Date : </td>
                                                                <td style="width: 40%" class="column_Left">
                                                                     <asp:TextBox ID="txtSAI_Date" runat="server" Width="40%" CssClass="txtbox_Date" AutoPostBack="true"></asp:TextBox>
                                                                ...
                                                                &nbsp;<span class="CalendarFormat">(MM/DD/YYYY)</span>
                                                                <cc1:CalendarExtender ID="CalendarExtender6" runat="server" TargetControlID="txtSAI_Date" PopupButtonID="txtSAI_Date" PopupPosition="TopLeft" Enabled="True"></cc1:CalendarExtender>

                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 10%; height: 21px;" class="column_RightBold">RIS Number :</td>
                                                                <td style="width: 40%; height: 21px;" class="column_Left">
                                                                    ...
                                                                    <asp:DropDownList ID="drpCategoryCode" runat="server" CssClass="drpdownCSS" Width="50px">
                                                                    ...
                                                                    <asp:TextBox ID="txtRIS" runat="server" CssClass="txtbox_Var" ReadOnly="true" Width="100px"></asp:TextBox>
                                                                </td>
                                                                <td class="column_RightBold">SAI Number : </td>
                                                                <td class="column_Left">
                                                                    <asp:TextBox ID="txtSAI_No" runat="server" CssClass="txtbox_Var" Width="40%"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 10%" class="column_RightBold">&nbsp;Department :</td>
                                                                <td style="width: 40%" class="column_Left">
                                                                    <asp:DropDownList ID="drpdept" runat="server" AutoPostBack="True" CssClass="drpdownCSS" Width="60%">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td style="width: 10%" class="column_RightBold">Issued By :</td>
                                                                <td style="width: 40%" class="column_Left">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 40%" class="column_Left">
                                                                    <asp:DropDownList ID="drpFunction" runat="server" AutoPostBack="True" CssClass="drpdownCSS" Width="60%">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 40%" class="column_Left">
                                                                    <asp:DropDownList ID="ddmr" runat="server" AutoPostBack="True" CssClass="drpdownCSS" Width="60%">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 40%" class="column_Left">
                                                                    <asp:DropDownList ID="ddReceive" runat="server" AutoPostBack="True" CssClass="drpdownCSS" OnSelectedIndexChanged="ddReceive_SelectedIndexChanged" Width="60%">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td style="width: 10%" class="column_RightBold"></td>
                                                                <td style="width: 40%" class="column_Left"></td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 10%" class="column_RightBold">Approved By :</td>
                                                                <td style="width: 40%" class="column_Left">
                                                                    <asp:DropDownList ID="drpApprovedBy" runat="server" CssClass="drpdownCSS" Width="60%" >
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td style="width: 10%" class="column_RightBold">&nbsp;</td>
                                                                <td style="width: 40%" class="column_Left">
