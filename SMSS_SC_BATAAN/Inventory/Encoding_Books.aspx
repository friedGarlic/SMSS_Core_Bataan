                              ...
                              <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        ...
                                        <asp:DropDownList ID="drpbookName" runat="server" Width="91%" OnSelectedIndexChanged="drpbookName_SelectedIndexChanged" AutoPostBack="true" ></asp:DropDownList>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        ...
                                        <asp:DropDownList ID="drpbookUnit"  runat="server" Width="100px" CssClass="drpdownCSS" ></asp:DropDownList>
                                ...
                                <tr>
                                    <td class="column_RightBold" style="width: 12%">Description :
                                    </td>
                                    <td class="column_Left" style="width: 30%">
                                        <asp:Label ID="lblbookdesciption" runat="server" Width="290px" SkinID="Label" Font-Italic="False" Visible="false"></asp:Label>
                                        <asp:TextBox ID="txtbookdesciption" runat="server" Width="89%"  CssClass="txtbox_Var"></asp:TextBox>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        ...
                                        <asp:TextBox ID="txtBookPrice" runat="server" Width="25%"  CssClass="txtbox_Var"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        <asp:TextBox ID="txtbookTitle" runat="server" Width="89%"  CssClass="txtbox_Var"></asp:TextBox>
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        <asp:TextBox ID="txtbookAuthor" runat="server" Width="89%" CssClass="txtbox_Var"></asp:TextBox>
                                    </td>
                                ...
                                <tr style="display:none">
                                    ...
                                    <td class="column_Left" style="width: 30%">
                                        ...
                                        <asp:TextBox ID="txtbookareacapacity" runat="server" Width="89%"  CssClass="txtbox_Var"></asp:TextBox>
                                    </td>
                               </tr>
                                <tr>
                                    <td colspan ="4">
                                        ...
                                        <table >
 <tr>
                                     <td  class="column_RightBold" style="width: 115px">Acquisition Date :
                                    </td>
                                    <td class="column_Left" style="width:100px;">
                                        <asp:Label ID="Label1" runat="server"></asp:Label>
                                        <asp:TextBox ID="txtbookAcqDate" runat="server" CssClass="txtbox_Var"  onchange="return NoOfYears(this.value);" ></asp:TextBox>
                                   ...
                                   <td class="column_RightBold" >Market Value :
                                    ...
                                    <td class="column_Left" >
                                        ...
                                        <asp:TextBox ID="txtbookMarketValue" runat="server" CssClass="txtbox_Var" Onkeyup="javascript:this.value=Comma(this.value);" Onchange="this.value=formatCurrency(this.value);"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="column_RightBold" style="width: 115px" >Acquisition Cost :
                                    </td>
                                    <td class="column_Left" >
                                        <asp:Label ID="Label2" runat="server" ></asp:Label>
                                        <asp:TextBox ID="txtbookAcqCost" runat="server" CssClass="txtboxAmount" Onkeyup="javascript:this.value=Comma(this.value);" Onchange="this.value=formatCurrency(this.value); return getSalVal(this),getDepValRate(this);"></asp:TextBox>
                                    </td>
                                    ...
                                    <td class="column_Left" >
                                        ...
                                        <asp:TextBox ID="txtNoYears" runat="server"  CssClass="txtbox_Var" onchange="return getDepValRate(this)" ></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="column_Left">
                                        <asp:TextBox ID="txtbookdepreciatedRate" runat="server" Width="100px"  CssClass="txtbox_Var" MaxLength="5" ></asp:TextBox>&nbsp;(%) Percent</td>
                                    ...
                                    <td class="column_Left">
                                        ...
                                        <asp:TextBox ID="txtbookUsefulLife" runat="server" Width="100px"  CssClass="txtbox_Var" onchange="return getDepValRate(this);"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="column_Left" >
                                        ...
                                        <asp:TextBox ID="txtbookdepreciatedvalue" runat="server" Width="100px" CssClass="txtboxAmount" Onkeypress="javascript:this.value=Comma(this.value);" Onchange="this.value=formatCurrency(this.value);"></asp:TextBox>
                                    </td>
                                    
                                   <td class="column_RightBold">Salvage Value :
                                    </td>
                                    <td class="column_Left" >
                                        <asp:TextBox ID="txtbookSalvageValue" runat="server" Width="85%" CssClass="txtboxAmount" Onkeypress="javascript:this.value=Comma(this.value);" Onchange="this.value=formatCurrency(this.value);"></asp:TextBox></td>
                                            ...
                                            <tr>
                                                 ...
                                                 <td class="column_Left">
                                                     <asp:TextBox ID="txtBookDepreciation" runat="server" CssClass="txtboxAmount" Onchange="this.value=formatCurrency(this.value);" Onkeypress="javascript:this.value=Comma(this.value);" Width="100px"></asp:TextBox>
                                                     (Per Year)</td>
                                                 <td>&nbsp;</td>
                                                 <td>&nbsp;</td>
                                            </tr>
