        ...
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <Columns>
                     ...
                     <tr>
                        <td align="center" class="DivTitle" style="width: 100%"><asp:Label ID="lblSubClass" runat="server" Text="OFFICE EQUIPMENT INFORMATION"></asp:Label>
                              ...
                              <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td class="column_Left" style="width: 30%"><asp:linkbutton ID="btnaddpropertyinfo" runat="server"  Text ="Add Property Information" OnClick="btnaddpropertyinfo_Click"></asp:linkbutton>
                                ...
                                <tr>
                                    <td colspan ="4">
                                        ...
                                        <table >
 <tr>
                                     <td  class="column_RightBold" style="width: 116px">Acquisition Date :
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="column_RightBold" style="width: 116px" >Acquisition Cost :
                                    </td>
                                    <td class="column_Left" >
                                ...
                                <tr>
                                    ...
                                    <td class="column_Left">
                                        <asp:TextBox ID="lblequipmentdepreciatedRate" runat="server" Width="50px"  CssClass="txtboxAmount" MaxLength="5" ReadOnly="True"></asp:TextBox>&nbsp;(%) Percent</td>
                                ...
                                <tr>
                                   ...
                                   <td class="column_RightBold">Salvage Value :
                                    ...
                                    <td class="column_Left" >
                                        <asp:TextBox ID="txtSalvageValue" runat="server" Width="140px" CssClass="txtboxAmount" onchange="this.value=formatCurrency(this.value);" >0.00</asp:TextBox></td>
