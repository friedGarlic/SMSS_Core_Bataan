                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td style="width: 100%" align="center">
                                                        ...
                                                        <asp:TextBox ID="txtSupplySearch1" runat="server" Width="350px" CssClass="txtbox_Var"></asp:TextBox>
                                                        <asp:Button ID="btnSupplySearch" OnClick="btnSupplySearch_Click" runat="server" CssClass="CSButton"
        ...
        <asp:TextBox ID="txtReceivedBy" runat="server" Width="60%" CssClass="txtbox_Var"></asp:TextBox>
                                ...
                                <asp:View ID="vwARE" runat="server">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td style="width: 100%" align="center">
                                                <asp:Button ID="btnADD_Item"
                                                    OnClick="btnADD_Item_Click"
                                                    runat="server"
                                                    CssClass="CSButton"
                                                    Width="150px"
                                                    Text="ADD"
                                        ...
                                        <tr>
                                            <td style="width: 100%" align="center">
                                                ...
                                                &nbsp;<asp:Button ID="btnTransferProperty" OnClick="btnReturnProperty_Click2" runat="server" CssClass="CSButton" Width="150px" Text="TRANSFER" Enabled="False"></asp:Button>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="width: 100%" align="center">
                                                ...
                                                <cc1:CalendarExtender ID="CalendarExtender1"
                                                    runat="server"
                                                    TargetControlID="txtDateReceivedBy"
                                                    Enabled="True"
                                                    PopupButtonID="txtDateReceivedBy">
                                    ...
                                    <asp:Panel ID="popReturn" runat="server" Width="400px" CssClass="Panel_Popup">
                                        <table width="100%" cellpadding="0px" cellspacing="0px">
                                            <tr>
                                                <td style="width: 100%; height: 30px" class="DivTitle">Transfer Details
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 100%" align="center">
                                                    <table width="100%">
                                                        <tr>
                                                            <td style="width: 20%; height: 38px;" class="column_RightBold">Date :</td>
                                                            <td style="width: 80%; height: 38px;" class="column_Left">
                                                                <asp:TextBox ID="txtDateTransfer" runat="server" Width="50%" CssClass="txtbox_Date"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td style="width: 20%" class="column_RightBold">Department :</td>
                                                            <td style="width: 80%" class="column_Left">
                                                                <asp:DropDownList ID="ddTransferDepartment" runat="server" Width="90%" CssClass="drpdownCSS"
                                                                    OnSelectedIndexChanged="ddTransferDepartment_SelectedIndexChanged" AutoPostBack="True">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 80%" class="column_Left">
                                                                <asp:DropDownList ID="ddTransferTo" runat="server" Width="90%" CssClass="drpdownCSS">
                                                                    <asp:ListItem Value="0">Select</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td style="width: 100%" colspan="2" align="center">
                                                                <asp:Button ID="btnReturnPro" OnClick="btnReturnPro_Click" runat="server" Width="120px" CssClass="CSButton" Text="Save Transfer" OnClientClick="StartProgressBar();"></asp:Button>
                                        ...
                                        <cc1:CalendarExtender ID="CalendarExtender4"
                                            runat="server"
                                            TargetControlID="txtDateTransfer"
                                            Enabled="True"
                                            PopupButtonID="txtDateTransfer">
                                        </cc1:CalendarExtender>
