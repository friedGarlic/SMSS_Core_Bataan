...
#End Region
    ...
    Protected Sub LoadPropertyDropDown()
        ...
        AddTrace("drpDepartment: " & drpDepartment.SelectedValue)
        Ppropertylist = Me.objDerived.GetDataTable("Exec [AMS].[sp_PropertyReturnSlip_ItemList] '" & Session("GA_ID") & "','" & drpDepartment.SelectedValue & "'", CommandType.Text)
    ...
    Protected Sub btnADD_Item_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If grListOfProperty.SelectedIndex < 0 OrElse grListOfProperty.SelectedDataKey Is Nothing Then
            MsgeBox.CreateMessageAlertInUpdatePanel(Me.UpdatePanel1, "Please select a property first.")
            Exit Sub
        End If
    ...
    Protected Sub drpPurpose_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)

        If grdIssueItems.Rows.Count <= 0 Then
            drpPurpose.SelectedValue = "0"
            MsgeBox.CreateMessageAlertInUpdatePanel(Me.UpdatePanel1, "Please add a property first.")
            Exit Sub
        End If
