...
Namespace BaseDLL
    ...
    Public Class BaseDAL
        ...
        Public LocalSqlServer As String = ConfigurationManager.ConnectionStrings("LocalSqlServer").ToString
        'Added for Imgae
        ' Public Imageconstr As String = ConfigurationManager.ConnectionStrings("Imageconstr").ToString
        ...
        '    End Set
        'End Property
        Public Overridable Function GetDataTableV2(ByVal strCmd As String, ByVal cmdType As CommandType, Optional ByVal param() As SqlParameter = Nothing) As DataTable
            ' Dim conStr As String = ConfigurationManager.ConnectionStrings("LocalSqlServer").ToString
            Dim dt As New DataTable
            cn = New SqlConnection(LocalSqlServer)
            Try
        ...
        End Function
        Public Overridable Function GetDataTableSysmanager(ByVal strCmd As String, ByVal cmdType As CommandType, Optional ByVal param() As SqlParameter = Nothing) As DataTable
            ' Dim conStr As String = ConfigurationManager.ConnectionStrings("LocalSqlServer").ToString
            Dim dt As New DataTable
            cn = New SqlConnection(LocalSqlServer)
            Try
        ...
        End Function
        Public Overridable Function GetRecordsSysmanager(ByVal strCmd As String, ByVal cmdType As CommandType, Optional ByVal param() As SqlParameter = Nothing) As DataSet
            ' Dim conStr As String = ConfigurationManager.ConnectionStrings("LocalSqlServer").ToString
        ...
        End Function
        Public Sub FillEntity(ByVal strCmd As String, ByVal cmdType As CommandType, Optional ByVal param() As SqlParameter = Nothing)
            cn = New SqlConnection(conStr)
            Try
                If Not IsNothing(param) Then
                    For Each p As SqlParameter In param
        ...
        Public Function Search(ByVal data As DataTable, ByVal searchby As String, ByVal SearchString As Object) As DataView
            ...
            ElseIf TypeOf SearchString Is Boolean Then
                myview.RowFilter = " " & searchby & " = '" & (SearchString) & "' "
            ElseIf TypeOf SearchString Is Integer Then
                myview.RowFilter = " " & searchby & " = '" & (SearchString) & "' "
            Else

                myview.RowFilter = " " & searchby & " Like '" & replaceapostrophe(SearchString.ToString) & "%'  "
                ' End If
