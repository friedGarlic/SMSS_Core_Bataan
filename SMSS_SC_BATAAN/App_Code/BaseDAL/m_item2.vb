...
#Region "property"
    ...
    Private pSubClassifId As Integer
    Public Property SubClassifId() As Integer
        Get
            Return pSubClassifId
        End Get
        Set(ByVal value As Integer)
            pSubClassifId = value
        End Set
...
#End Region
    Public Function save() As Long
        ...
        objDerived.cmd.Parameters.AddWithValue("@SubCategoryID", SubCategoryId)
        ...
        i = objDerived.Execute("@CurrID", "ams.spSave_m_item2", CommandType.StoredProcedure, Nothing)
        Return i
    End Function
