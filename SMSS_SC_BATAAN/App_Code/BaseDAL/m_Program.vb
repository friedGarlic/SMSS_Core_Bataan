...
Public Class m_Program
    ...
    Public Sub saveProgram()
        ...
        End With
        Execute("dbo.spSave_m_Program", Data.CommandType.StoredProcedure)
    End Sub
    ...
    Public Sub updateProgram()
        ...
        Execute("@CurrID", "dbo.spSave_m_Program", Data.CommandType.StoredProcedure)
    End Sub

    Public Function selectInfo() As DataTable
        Me.cmd.Parameters.AddWithValue("Program_Name", pProgram_Name)
        Dim x As New DataTable
        x = Me.GetDataTable("BOS.program_searchInfo", CommandType.StoredProcedure)
        Return x
    End Function
End Class
