...
#Region "property"
    ...
    Private pInstalledAt As String
...
#End Region
    Public Function save() As Long
        ...
        objDerived.cmd.Parameters.AddWithValue("@ChassisNo", If(String.IsNullOrWhiteSpace(ChassisNo), CType(DBNull.Value, Object), ChassisNo))
        objDerived.cmd.Parameters.AddWithValue("@EngineNo", If(String.IsNullOrWhiteSpace(EngineNo), CType(DBNull.Value, Object), EngineNo))


        objDerived.cmd.Parameters.AddWithValue("@MarketValue", If(MarketValue.HasValue, CType(MarketValue, Object), DBNull.Value))
        objDerived.cmd.Parameters.AddWithValue("@Location", If(String.IsNullOrWhiteSpace(Location), CType(DBNull.Value, Object), Location))
        objDerived.cmd.Parameters.AddWithValue("@InstalledAt", If(String.IsNullOrWhiteSpace(InstalledAt), CType(DBNull.Value, Object), InstalledAt))
