...
Public Class Consolidated_Canvass_Limited
    '=-= m_Canvass_Hdr
#Region "m_Canvass_Hdr"
    ...
    Public Class m_Canvass_Hdr
        ...
        Public Function save() As Long
            ...
            i = objDerived.Execute("@CurrID", "[AMS].[spSave_m_Canvass_Hdr_limited]", CommandType.StoredProcedure, Nothing)
            Return i
        End Function
...
#Region "m_Canvass_Dtl1"
    ...
    Public Class m_Canvass_Dtl1
        ...
        Public Function save() As Long
            ...
            objDerived.cmd.Parameters.AddWithValue("@withWinner", withWinner)
            objDerived.cmd.Parameters.Add("@CurrID", SqlDbType.BigInt).Direction = ParameterDirection.Output
            i = objDerived.Execute("@CurrID", "[AMS].[spSave_m_Canvass_Dtl1_limited]", CommandType.StoredProcedure, Nothing)
            Return i
        End Function
...
#Region "m_Canvass_Dtl2"
    ...
    Public Class m_Canvass_Dtl2
        ...
        Public Function save() As Long
            ...
            objDerived.cmd.Parameters.Add("@CurrID", SqlDbType.BigInt).Direction = ParameterDirection.Output
            i = objDerived.Execute("@CurrID", "[AMS].[spSave_m_Canvass_Dtl2_limited]", CommandType.StoredProcedure, Nothing)
            Return i
        End Function
...
#Region "m_Canvass_Dtl_PR1"
    ...
    Public Class m_Canvass_Dtl_PR1
        ...
        Public Function save() As Long
            ...
            objDerived.cmd.Parameters.AddWithValue("@isWinner", isWinner)
            objDerived.cmd.Parameters.Add("@CurrID", SqlDbType.BigInt).Direction = ParameterDirection.Output
            i = objDerived.Execute("@CurrID", "[AMS].[spSave_m_Canvass_Dtl_PR1_limited]", CommandType.StoredProcedure, Nothing)
            Return i
        End Function
...
#Region "m_Canvass_Dtl_PR2"
    ...
    Public Class m_Canvass_Dtl_PR2
        ...
        Public Function save() As Long
            ...
            objDerived.cmd.Parameters.Add("@CurrID", SqlDbType.BigInt).Direction = ParameterDirection.Output
            i = objDerived.Execute("@CurrID", "[AMS].[spSave_m_Canvass_Dtl_PR2_limited]", CommandType.StoredProcedure, Nothing)
            Return i
        End Function
