...
Public Class t_purchase_request_hdr_DBM
...
#Region "properties"
    ...
    Public Property prhdr_id() As Long
        ...
        End Set
    End Property
    Private pprDBM_id As Long
    Public Property prDBM_id() As Long
        Get
            Return pprDBM_id
        End Get
        Set(ByVal value As Long)
    ...
    Private pPRDBM_DATE As DateTime
    Public Property PRDBM_DATE() As DateTime
        Get
            Return pPRDBM_DATE
        End Get
...
#End Region
    ...
    Public Function save() As Long
        ...
        Dim i As Long
        objDerived.cmd.Parameters.AddWithValue("@prdbm_id", 0)
