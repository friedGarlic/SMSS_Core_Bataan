...
Public Class t_bid_opening_dtl
    Inherits BaseDLL.BaseDAL
#Region "property"
    Private pbid_opening_dtl_id As Long
    Public Property bid_opening_dtl_id() As Long
        Get
            Return pbid_opening_dtl_id
        End Get
        Set(ByVal value As Long)
            pbid_opening_dtl_id = value
        End Set
    End Property
...
#End Region
    Public Function save() As Long
        ...
        Dim i As Long
        objDerived.cmd.Parameters.AddWithValue("@bid_opening_dtl_id", 0)
        ...
        i = objDerived.Execute("@CurrID", "AMS.spSave_bid_opening_dtl", CommandType.StoredProcedure, Nothing)
        Return i
    End Function
    ...
    Public Function update() As Long
        ...
        objDerived.conStr = objDerived.DbaseConnect()
        Dim i As Long
        objDerived.cmd.Parameters.AddWithValue("@bid_opening_dtl_id", bid_opening_dtl_id)
        objDerived.cmd.Parameters.AddWithValue("@bid_opening_hdr_id", bid_opening_hdr_id)
        objDerived.cmd.Parameters.AddWithValue("@item_id", item_id)
        objDerived.cmd.Parameters.AddWithValue("@qty", qty)
        objDerived.cmd.Parameters.AddWithValue("@Cost", Cost)
