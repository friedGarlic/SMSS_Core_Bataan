...
#End Region
        ...
        Try
            ...
            While rd.Read()
                With Me
                    ...
                    .Trush_Fund_Description = IIf(IsDBNull(rd("Trush_Fund_Description")), "", rd("Trush_Fund_Description"))
                End With
            End While
    ...
    Public Sub saveProject()
        With Me
            ...
            .cmd.Parameters.AddWithValue("@Trush_Fund_Description", pTrush_Fund_Description)
            .cmd.Parameters.Add("@CurrID", SqlDbType.BigInt).Direction = ParameterDirection.Output
        End With

        Execute("dbo.spSave_m_Project", Data.CommandType.StoredProcedure)
    End Sub
    ...
    Public Sub updateProject()
        ...
        Execute("@CurrID", "dbo.spSave_m_Project", Data.CommandType.StoredProcedure)
    End Sub
    ...
    Public Function getProjList(ByVal budgetYear As String, ByVal ProgName As String) As DataTable
        ...
        Dim x As DataTable
        x = Me.GetDataTable("BOS.project_GetList", CommandType.StoredProcedure)
        Return x
    End Function
    ...
    Public Function getProjID() As DataTable
        ...
        x = Me.GetDataTable("BOS.project_getID", CommandType.StoredProcedure)
        Return x
    End Function
