...
Partial Class bidding_CanvassResolution_ReportEdit
    ...
    Private Sub bidding_CanvassResolution_ReportEdit_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If MOP = 3 Or MOP = 4 Then
            dtitems = objDerived.GetDataTable("EXEC [AMS].[sp_rpt_Abstract_Canvass_Dtl_v2] '" & Session("prhdr_id") & "','" & Session("Hdr_ID") & "'", CommandType.Text)
        ...
        Else
            ...
            mvMOP.SetActiveView(Me.vwCanvasss)
        End If
