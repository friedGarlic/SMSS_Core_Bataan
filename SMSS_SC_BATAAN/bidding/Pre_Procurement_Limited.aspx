<%@ Page 
    ...
    CodeFile="Pre_Procurement_Limited.aspx.vb" 
    Inherits="bidding_Pre_Procurement_Limited"
                                                                        ...
                                                                        <asp:GridView runat="server" ID="grdITB" SkinID="GridViewAA" Width="100%" EmptyDataText="No Data Found."
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                                                    <ItemTemplate>
                                                                                        <asp:CheckBox runat="server" ID="cb1" Visible='<%# Bind("isVisible") %>'  OnCheckedChanged="CheckITB" AutoPostBack="true"/>
                                                                                    </ItemTemplate>
                                                                                    <ItemStyle Width="3%" />
                                                                                </asp:TemplateField>
                                                                                ...
                                                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Purpose / Project Name">
                                                                                    <ItemTemplate>
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td style="width: 100%" align="center">
                                                            ...
                                                            <asp:GridView runat="server" ID="grdPreProcurement" SkinID="GridViewAA" Width="90%" EmptyDataText="No Data Found."
                                                                DataKeyNames="obr_evaluation_hdr_id,obr_evaluation_dtl_id,ProjectName,ABC,ITB_No,BidOpening_Date,BidOpening_Time,BidOpening_Place,Transaction_type">
                                                                <Columns>
                                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField ItemStyle-Width="65%" DataField="ProjectName" HeaderText="Contract / Project Name" ItemStyle-HorizontalAlign="Left" />
                                                    ...
                                                    <tr>
                                                        <td style="width: 100%" align="center">
                                                            ...
                                                            &nbsp;<asp:Button runat="server" ID="btnPreviewOP" Visible ="False" Text="Order of Payment" CssClass="CSButton" Enabled="false" Width="150px" OnClientClick="StartProgressBar();" />
