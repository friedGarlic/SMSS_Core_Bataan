<%@ Page 
    ...
    CodeFile="t_canvass_good_direct_contraction.aspx.vb"
    Title="Canvass Good Direct Contracting" 
    Inherits="bidding_t_canvass_good_direct_contraction"
                                            ...
                                            <tr>
                                                <td style="width: 100%" align="center">
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                        <ContentTemplate>
                                                            <asp:Panel ID="Panel2" runat="server" Width="98%" CssClass="PanelSize" HorizontalAlign="Center">
                                                                <asp:Panel ID="Panel3" runat="server" Width="100%" CssClass="PanelSize" HorizontalAlign="Center" ScrollBars="Vertical">
                                                                    <asp:GridView ID="grdPerItems" runat="server" Width="100%" SkinID="GridViewAA" PageSize="10" DataKeyNames="Item_ID" ShowFooter="True" EmptyDataText="No Data Found.">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Approved Budget" Visible="True">
                                                                                <ItemTemplate>
