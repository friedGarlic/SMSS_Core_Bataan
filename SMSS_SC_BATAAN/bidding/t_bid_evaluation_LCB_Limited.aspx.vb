...
Partial Class bidding_t_bid_evaluation_LCB_Limited
...
#End Region
    ...
    Protected Sub btnWinner_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        'Dim GetPR_ID As New Integer
        'Dim GetHrd_ID As Integer
        'Dim GetDtl_ID1 As Integer


        'GetPR_ID = objDerived.GetValue("select PR_Hdr_ID from view_limitedWinner where pre_procurement_hdr_id='" & PreProcurementID & "'", CommandType.Text)
