<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="rpt_notice_to_proceed.aspx.vb" Inherits="rpt_notice_to_proceed" Title="Notice to Proceed" StylesheetTheme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <table width="1020px">
            <tr>
                <td style="width: 1%"></td>
                <td style="width: 98%" class="PageTitle">NOTICE TO PROCEED</td>
                <td style="width: 1%"></td>
            </tr>
            <tr>
                <td style="width: 1%"></td>
                            ...
                            <tr>
                                <td style="width: 100%" align="center">
                                    ...
                                    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                                        <Report FileName="rpt_notice_to_proceed.rpt">
                                        </Report>
