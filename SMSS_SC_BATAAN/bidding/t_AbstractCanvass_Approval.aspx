<%@ Page 
    ...
    CodeFile="t_AbstractCanvass_Approval.aspx.vb"
    Inherits="bidding_t_AbstractCanvass_Approval"
    Title="Approval of Abstract of Canvass"
                    ...
                    <tr>
                        ...
                        <td style="width: 98%" align="center">
                            <asp:GridView ID="grdAbstractCanvass" runat="server" Width="98%" OnPageIndexChanging="grdAbstractCanvass_PageIndexChanging"
                                AllowPaging="True" SkinID="GridViewAA" AutoGenerateColumns="False" PageSize="8" DataKeyNames="Supplier_ID,Hdr_ID,prhdr_id"
