<%@ Page 
    ...
    CodeFile="Eligibility.aspx.vb"
    Inherits="bidding_Eligibility" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function updateStatus(rowId) {
            // Get the controls for the current row
            var txtBidSecAmt = document.getElementById("txtBidSecAmt_1_" + rowId);
                var txtReqBidSec = document.getElementById("txtReqBidSec_1_" + rowId);
                var lblStatus = document.getElementById("lblStatus_" + rowId);

            // Parse the values to ensure numeric comparison
            var bidSecAmt = parseFloat(txtBidSecAmt.value) || 0;
            var reqBidSec = parseFloat(txtReqBidSec.value) || 0;

            // Update the lblStatus based on the condition
            if (bidSecAmt > reqBidSec) {
                lblStatus.innerText = "Insufficient";
            } else {
                lblStatus.innerText = "Sufficient";
            }
        }
                                                                                                ...
                                                                                                <td style="width: 50%" align="center">
                                                                                                    <table width="100%">
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td style="width: 70%" class="column_Left">
                                                                                                                <asp:TextBox ID="txtBidSecAmt_1" runat="server" Width="40%" CssClass="txtbox_Amt" Text="0.00" ReadOnly="True" onchange="updateStatus('<%# Container.DataItemIndex %>')" ></asp:TextBox>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td style="width: 70%" class="column_Left">
                                                                                                                <asp:TextBox ID="txtReqBidSec_1" runat="server" Width="40%" CssClass="txtbox_Amt" Text="0.00" onchange="updateStatus('<%# Container.DataItemIndex %>')"></asp:TextBox>
                                                            ...
                                                            <asp:GridView runat="server" ID="grdSummary" SkinID="GridViewAA" Width="90%" EmptyDataText="No Data Found." AllowPaging="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Total Amount">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox runat="server" ID="txtTotalAmt" CssClass="txtbox_Amt" Width="95%" text='<%#Bind("calculatedAmount", "{0:N}") %>' AutoPostBack="true" OnTextChanged="txtTotalAmt_OnTextChanged"></asp:TextBox>
