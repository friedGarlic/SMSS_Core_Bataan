...
Partial Class bidding_t_Direct_Contracting_Contract
...
#End Region
    ...
    Private Sub ReloadAbstractCanvassData(ByVal newPageIndex As Integer)
        Dim dtAbstract As DataTable = objDerived.GetDataTable("EXEC [AMS].[sp_AbstractofCanvass_Approval_Direct]", CommandType.Text)
        If dtAbstract.Rows.Count < 8 Then
            dtAbstract.Merge(CreateTable1(8 - dtAbstract.Rows.Count))
        End If
