<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="rpt_failure_bidding.aspx.vb" Inherits="bidding_rpt_failure_bidding" title="Untitled Page" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <cr:crystalreportsource id="CrystalReportSource1" runat="server"><REPORT FileName="rpt_failure_bidding.rpt" /></cr:crystalreportsource>
