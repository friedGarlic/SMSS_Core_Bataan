<%@ Page 
    ...
    CodeFile="t_canvass_goods.aspx.vb" 
    Inherits="bidding_t_canvass_goods"
    Title="Canvass (Goods)" 
        ...
        <ContentTemplate>
            ...
            <div>
                <table width="100%">
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%" class="PageTitle">CANVASS GOODS
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                    ...
                    <tr>
                                                                ...
                                                                <asp:GridView ID="grdPerItems" runat="server" Width="100%" SkinID="GridViewAA" PageSize="10" DataKeyNames="Item_ID" ShowFooter="True" EmptyDataText="No Data Found.">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Quantity">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtqty" runat="server" Width="99%" Text='<%#Bind("Quantity") %>' CssClass="txtboxAmount" AutoPostBack="True" OnTextChanged="txtqty_TextChanged"></asp:TextBox>
                                                                                ...
                                                                                <asp:Panel Style="display: none" ID="pnlDetail" runat="server" Width="400px" BorderWidth="2px" BorderColor="#FFA016" BorderStyle="Solid" BackColor="White">
                                                                                    <table style="width: 100%; text-align: center">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="width: 100%">
                                                                                                    <asp:TextBox ID="txtItemSpecs" runat="server" Text='<%#Bind("PR_ItemSpecs") %>' Width="99%" CssClass="text" Height="150px" TextMode="MultiLine"></asp:TextBox></td>
                                                                                            </tr>
                                                                                            <tr>
                     ...
                     <tr>
                        ...
                        <td style="width: 98%" align="center">
                            ...
                            &nbsp;<asp:Button ID="btnPrint" OnClick="btnPrint_Click" runat="server" Width="150px" CssClass="CSButton" OnClientClick="StartProgressBar();" Text="PREVIEW RFQ" Enabled="False"></asp:Button>
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
