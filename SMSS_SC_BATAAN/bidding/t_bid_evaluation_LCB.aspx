<%@ Page 
    ...
    CodeFile="t_bid_evaluation_LCB.aspx.vb" 
    Inherits="bidding_t_bid_evaluation_LCB"
        ...
        <ContentTemplate>
            ...
            <div>
                <table width="1020px">
                    ...
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%">Bidders list : 
                             <asp:DropDownList ID="drpListOfBidders" CssClass="drpdownCSS" runat="server" Width="350px" OnSelectedIndexChanged="drpListOfBidders_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList></td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
                        <td style="width: 1%"></td>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 35%" class="column_Left">
                                        <asp:DropDownList ID="ddBACSetup" runat="server" AutoPostBack="True" CssClass="drpdownCSS" OnSelectedIndexChanged="ddBACSetup_SelectedIndexChanged">
                                            <asp:ListItem Value="3">3 BAC Members</asp:ListItem>
                                            <asp:ListItem Value="5" Selected="True">5 BAC Members</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 35%" class="column_Left">
                                        <asp:DropDownList ID="ddBAC1" runat="server" Width="90%" AutoPostBack="True" CssClass="drpdownCSS"></asp:DropDownList>
                                    </td>
                                    <td style="width: 15%" class="column_RightBold">BAC Vice Chairman:</td>
                                    <td style="width: 35%" class="column_Left">
                                        <asp:DropDownList ID="ddBACVC" runat="server" Width="90%" AutoPostBack="True" CssClass="drpdownCSS"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 15%" class="column_RightBold">BAC Member 2:</td>
                                    <td style="width: 35%" class="column_Left">
                                        <asp:DropDownList ID="ddBAC2" runat="server" Width="90%" AutoPostBack="True" CssClass="drpdownCSS"></asp:DropDownList>
                                    </td>
                                    <td style="width: 15%" class="column_RightBold">BAC Chairman:</td>
                                    <td style="width: 35%" class="column_Left">
                                        <asp:DropDownList ID="ddBACC" runat="server" Width="90%" AutoPostBack="True" CssClass="drpdownCSS"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 15%" class="column_RightBold">BAC Member 3:</td>
                                    <td style="width: 35%" class="column_Left">
                                        <asp:DropDownList ID="ddBAC3" runat="server" Width="90%" AutoPostBack="True" CssClass="drpdownCSS"></asp:DropDownList>
                                    </td>
                                    <td style="width: 15%" class="column_RightBold">BAC TWG-HEAD:</td>
                                    <td style="width: 35%" class="column_Left">
                                        <asp:DropDownList ID="ddBACTWGH" runat="server" Width="90%" AutoPostBack="True" CssClass="drpdownCSS"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr id="trBAC4" runat="server">
                                    <td style="width: 15%" class="column_RightBold">BAC Member 4:</td>
                                    <td style="width: 35%" class="column_Left">
                                        <asp:DropDownList ID="ddBAC4" runat="server" Width="90%" AutoPostBack="True" CssClass="drpdownCSS"></asp:DropDownList>
                                    </td>
                                    <td style="width: 15%" class="column_RightBold">End User:</td>
                                    <td style="width: 35%" class="column_Left">
                                        <asp:DropDownList ID="ddEndUser" runat="server" Width="90%" AutoPostBack="True" CssClass="drpdownCSS"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr id="trBAC5" runat="server">
                                    <td style="width: 15%" class="column_RightBold">BAC Member 5:</td>
                                    <td style="width: 35%" class="column_Left">
                                        <asp:DropDownList ID="ddBAC5" runat="server" Width="90%" AutoPostBack="True" CssClass="drpdownCSS"></asp:DropDownList>
                                    </td>
                                    <td style="width: 15%" class="column_RightBold"></td>
                                    <td style="width: 35%" class="column_Left"></td>
                                </tr>
