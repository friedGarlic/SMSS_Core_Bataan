<%@ 
    Page Language="VB"
    Title="Canvass Resolution Report - Negotiated"
    MasterPageFile="~/MasterPage.master"
    AutoEventWireup="false" 
    CodeFile="CanvassResolution_ReportEdit_Nego.aspx.vb" 
    Inherits="bidding_CanvassResolution_ReportEdit_Nego"
        ...
        <ContentTemplate>
            ...
            <div>
                <table width="1020px">
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%" class="PageTitle">CANVASS RESOLUTION AWARD</td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
                        <td style="width: 1%"></td>
                    ...
                    <tr>
                        ...
                        <td style="width: 98%" align="center">
                            <asp:MultiView runat="server" ID="mvMOP">
                                <asp:View runat="server" ID="vwCanvass">
            ...
            <asp:Button Style="border-top-style: none; border-right-style: none; border-left-style: none; position: relative; background-color: transparent; border-bottom-style: none" ID="ButtonProgress" runat="server" Width="16px" Enabled="false" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
