<%@ Page 
    ...
    CodeFile="t_repeatorderapproval.aspx.vb" 
    Inherits="bidding_t_repeatorderapproval"
        ...
        <ContentTemplate>
            ...
            <div>
                <table width="100%">
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%" class="PageTitle">REPEAT ORDER - APPROVAL
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 98%" align="center">
                            ...
                            &nbsp;<asp:Button ID="btnResolution" OnClick="btnResolution_Click" runat="server" Width="200px" CssClass="CSButton" OnClientClick="StartProgressBar();" Enabled="false" Text="Preview BAC Resolution"></asp:Button>
