<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="t_CanvassAwards.aspx.vb"
    Inherits="bidding_t_CanvassAwards" Title="CANVASS AWARDS" EnableEventValidation="false" StylesheetTheme="SkinFile" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <table width="100%">
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%" class="PageTitle">CANVASS REPORTS</td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
                        <td style="width: 1%"></td>
                                        ...
                                        <asp:MultiView runat="server" ID="mvTabs">
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td style="width: 100%" align="center">
                                                            ...
                                                            &nbsp;<asp:Button ID="btnSearch_NOA" runat="server" Width="15%" CssClass="CSButton" Text="Search" OnClientClick="StartProgressBar();"></asp:Button>

                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%" align="center">
                                                            <asp:GridView ID="grdAbstract" runat="server" Width="100%" EmptyDataText="No Data Found." AllowPaging="true" PageSize="10" SkinID="GridViewAA"
                                                                DataKeyNames="Hdr_ID,Supplier_ID,PR_No,Total_Amt,prhdr_id">
                                                                <Columns>
                                                                    <asp:BoundField DataField="MOP" HeaderText="Mode of Procurement">
                                                                        <ItemStyle HorizontalAlign="Center" Width="20%"></ItemStyle>
                                                                    </asp:BoundField>
                                            ...
                                            <asp:View runat="server" ID="vwNTP">
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td style="width: 100%" align="center">
                                                            <asp:GridView runat="server" ID="grdNTP" Width="90%" SkinID="GridViewAA" AllowPaging="true" PageSize="10" EmptyDataText="No Data Found."
                                                                DataKeyNames="CanvassAward_ID,ProjectName,Supp_ABC,PO_No,SuppName">
                                                                <Columns>
            ...
            <%--            <div>
                <table width="1020px">
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%" class="PageTitle">CANVASS REPORTS
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 98%" align="left">
                            <asp:Button ID="btnResolution" runat="server" CssClass="Initial" OnClick="btnResolution_Click" OnClientClick="StartProgressBar();" Text="RESOLUTION OF AWARD" Width="250px" />
                            <asp:Button ID="btnNOA" OnClick="btnNOA_Click" runat="server" Width="250px" Text="NOTICE OF AWARD" OnClientClick="StartProgressBar();" CssClass="Initial"></asp:Button>
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 98%" align="center">
                            <asp:MultiView ID="mvAwards" runat="server">
                                <asp:View ID="vwNOA" runat="server">
                                    <table style="width: 100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width: 100%" align="center">
                                                    <asp:Panel ID="Panel3" runat="server" Width="98%" Font-Bold="True" CssClass="PanelSize" BorderStyle="Solid" BorderColor="Silver" BorderWidth="1px" HorizontalAlign="Center" ScrollBars="Vertical">
                                                    </asp:Panel>
                                                </td>
                                            </tr>
                                        </tbody>
                                 ...
                                 <asp:View ID="vwResolution" runat="server">
                                    <table style="width: 100%">
                                        <tbody>
                                            <tr>
                                                <td style="width: 100%" align="center">
