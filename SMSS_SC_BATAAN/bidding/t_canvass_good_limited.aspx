<%@ Page Language="VB" 
    ...
    CodeFile="t_canvass_good_limited.aspx.vb" 
    Inherits="bidding_t_canvass_good_limited" 
    Title="Canvass Good Limited Source" 
        ...
        <ContentTemplate>
            ...
            <div>
                <table width="100%">
                    <tr>
                        <td style="width: 1%"></td>
                        <td style="width: 98%" class="PageTitle">Identification of Supplier
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                        ...
                        <td style="width: 98%" align="left">
                            <table>
                                <tr>
                                    ...
                                    <td class="column_Left"><asp:DropDownList ID="drpModeOfProcurement" runat="server" Width="200px" OnSelectedIndexChanged="drpModeOfProcurement_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList></td>
                                </tr>
                            </table>
                                                                ...
                                                                <asp:GridView ID="grdPerItems" runat="server" Width="100%" SkinID="GridViewAA" PageSize="10" DataKeyNames="Item_ID" ShowFooter="True" EmptyDataText="No Data Found.">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Quantity">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtqty" runat="server" Width="95%" Text='<%# Bind("Quantity") %>' CssClass="txtboxAmount" AutoPostBack="True" OnTextChanged="txtqty_TextChanged" Enabled="false"></asp:TextBox>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Bidder's Unit Price">
                                                                            <FooterTemplate>
                                                                                <asp:Label ID="Label2" runat="server" Text="TOTAL :"></asp:Label>
                                                                            </FooterTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtCost1" runat="server" Width="95%" Text='<%# Bind("cost", "{0:N}") %>' CssClass="txtboxAmount" AutoPostBack="True" OnTextChanged="txtCost1_TextChanged"></asp:TextBox>
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Total Amount">
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtTotal1" runat="server" Width="95%" CssClass="txtboxAmount" ReadOnly="True">0.00</asp:TextBox>
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="font-size: 9pt; width: 100%; color: red; font-style: italic; font-family: Calibri; text-align: left">
                                                                                                    Note: Use Comma " , " to separate each specification.
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td style="width: 100%">
                                                                                ...
                                                                                <cc1:ModalPopupExtender ID="ModalPopupExtender2" runat="server" TargetControlID="btnDetail" PopupControlID="pnlDetail" BackgroundCssClass="modalBackground" CancelControlID="Button6" DynamicServicePath=""></cc1:ModalPopupExtender>
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                                                        </asp:TemplateField>
                        ...
                        <td style="width: 98%" align="center">
                            <asp:GridView ID="grdSupplier1" runat="server" Width="90%" SkinID="GridViewAA" PageSize="1" DataKeyNames="Supplier_ID,SuppName" AutoGenerateColumns="False" OnSelectedIndexChanged="grdSupplier1_SelectedIndexChanged"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="List of Items" Visible="True">
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" ID="TextBox1"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkviewItems" OnClick="lnkviewItems_Click" runat="server" CausesValidation="False" CommandName="Select" CssClass="LinkBtnPreview" Font-Underline="False" Text="View Items" Visible ="True"></asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="10%"></ItemStyle>
                                    </asp:TemplateField>
                                </Columns>
