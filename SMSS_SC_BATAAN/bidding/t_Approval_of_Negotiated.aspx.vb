...
Partial Class bidding_t_Approval_of_Negotiated
...
#Region "Tables"
    Public Function CreateTable1(ByVal row As Integer) As DataTable
        ...
        dt.Columns.Add("Suppliers", GetType(Integer))
...
#End Region
    ...
    Protected Sub LoadGrids()
        dtAbstract = objDerived.GetDataTable("EXEC [AMS].[sp_AbstractofCanvass_Approval_Direct_Nego_New]", CommandType.Text)
    ...
    Private Sub ReloadAbstractCanvassData(ByVal newPageIndex As Integer)
        Dim dtAbstract As DataTable = objDerived.GetDataTable("EXEC [AMS].[sp_AbstractofCanvass_Approval_Direct_Nego]", CommandType.Text)
        If dtAbstract.Rows.Count < 8 Then
            dtAbstract.Merge(CreateTable1(8 - dtAbstract.Rows.Count))
        End If
    ...
    Protected Sub grdAbstractCanvass_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        'grdItemList.DataBind()
        pSuppliers = objDerived.GetDataTable("EXEC [AMS].[sp_CanvassBidder_List_Nego] '" & grdAbstractCanvass.SelectedDataKey("prhdr_id") & "'", CommandType.Text)
    ...
    Protected Sub grdSupplier2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        If Lbtn = "view" Then
            Dim dtItems As New DataTable
            dtItems = objDerived.GetDataTable("EXEC [AMS].[sp_Abstract_ItemList_Direct_Nego] '" & grdAbstractCanvass.SelectedDataKey("Hdr_ID") & "','" & grdSupplier2.SelectedDataKey("Supplier_ID") & "','" & grdAbstractCanvass.SelectedDataKey("prhdr_id") & "'", CommandType.Text)
    ...
    Protected Sub grdSupplier2_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            e.Row.Attributes.Add("onclick", ClientScript.GetPostBackEventReference(grdSupplier2, "Select$" + e.Row.RowIndex.ToString()))
        End If
    End Sub
    ...
    Protected Sub btnApproved_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            For i As Integer = 0 To countgrdItemList - 1
                Dim id As Long
                Dim Dtl_ID_PR1 As Long
                Dtl_ID_PR1 = dtItems.Rows(i)("Dtl_ID_PR1")


                id = grdSupplier2.SelectedDataKey("Supplier_ID")

                objDerived.GetRecords("UPDATE AMS.m_Canvass_Dtl_PR1 SET isWinner = 1 WHERE Dtl_ID_PR1 = '" & Dtl_ID_PR1 & "' AND Supplier_Id = '" & id & "'", CommandType.Text)
    ...
    Protected Sub btnPreviewBacReso_Click(sender As Object, e As EventArgs)
        ...
        Session("pre_procurement_hdr_id") = intGetPreProcurementID

        Dim url As String = "/MainReports/Bidding_Reports.aspx?"
