<%@ Page 
    ...
    CodeFile="t_abstract_of_bids.aspx.vb" 
    Inherits="t_abstract_of_bids"
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 98%" align="center">
                            ...
                            &nbsp;<asp:Button ID="btnPreviewCalculated" OnClick="btnPreviewCalculated_Click" runat="server" Width="180px" CssClass="CSButton" Enabled="False" Text="PREVIEW"></asp:Button>
