<%@ Page Title="BAC RESOLUTION" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RQ_BAC_ResolutionR.aspx.vb"
    Inherits="bidding_RQ_BAC_Resolution" EnableEventValidation="false" StylesheetTheme="SkinFile" %>
                        ...
                        <td style="width: 98%" align="left" valign="bottom">
                            <table cellpadding="0px" cellspacing="0px" width="100%">
                                <tr>
                                    ...
                                    <td style="width: 20%" align="left">
                                        <asp:Button runat="server" ID="btnTab3" Width="100%" Text="CANVASS" CssClass="TabButton_InActive" OnClientClick="StartProgressBar();" />
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 100%" colspan="3" class="PanelMessage">
                                        <asp:MultiView runat="server" ID="mvTabs">
                                            ...
                                            <asp:View runat="server" ID="vwTab3">
                                                <table width="100%">
                                                    <tr>
                                                        <td style="width: 100%; height: 10px"></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%" align="center">
                                                            <span class="column_RightBold">Search By :</span>&nbsp;
				                                            <asp:DropDownList runat="server" ID="drpCanvassSearch" Width="150px">
                                                                <asp:ListItem Value="1" Text="OBR Number"></asp:ListItem>
                                                                <asp:ListItem Value="2" Text="PR Number"></asp:ListItem>
                                                            </asp:DropDownList>&nbsp;
				                                            <asp:TextBox runat="server" ID="txtCanvassSearch" Width="200px" CssClass="txtbox_Var"></asp:TextBox>&nbsp;
				                                            <asp:Button runat="server" ID="btnCanvassSearch" CssClass="CSButton" Width="150px" Text="SEARCH" />
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td style="width: 100%" align="center">
                                                            <asp:GridView ID="grdCanvass" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="Hdr_ID, Supplier_ID, prhdr_id, OBR_No, Canvass_Date" PageSize="20" SkinID="GridViewAA" Width="98%" EmptyDataText="No Data Found.">
                                                                <Columns>
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton runat="server" Text="Preview" Font-Underline="false" CssClass="LinkBtnPreview" CommandName="Select" OnClientClick="StartProgressBar();"></asp:LinkButton>
