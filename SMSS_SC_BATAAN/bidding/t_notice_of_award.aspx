<%@ Page 
    ...
    CodeFile="t_notice_of_award.aspx.vb" 
    Inherits="t_notice_of_award"
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 98%" align="center">
                            ...
                            &nbsp;<asp:Button ID="btnResolution" OnClick="btnResolution_Click" runat="server" Width="180px" CssClass="CSButton"  Enabled="False" OnClientClick="StartProgressBar();" Text="PREVIEW BAC RESOLUTION" Visible="True" />
