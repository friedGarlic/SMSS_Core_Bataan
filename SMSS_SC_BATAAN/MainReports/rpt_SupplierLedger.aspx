<%@ Page Title="Supplier Ledger Report" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="rpt_SupplierLedger.aspx.vb"
    Inherits="MainReports_rpt_SupplierLedger" StylesheetTheme="SkinFile" %>
        ...
        <table width="1020px">
            ...
            <tr>
                ...
                <td style="width: 98%" align="center">
                             <%--       <CR:CrystalReportViewer ID="SupplierLedger" runat="server" AutoDataBind="true" DisplayGroupTree="False" HasToggleGroupTreeButton="False" HasCrystalLogo="False"
                                        BackColor="#ffffff" BestFitPage="true" />--%>
                                           <CR:CrystalReportViewer ID="SupplierLedger" runat="server"  AutoDataBind="true" HasToggleGroupTreeButton="False" HasCrystalLogo="False" 
