...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function PrintReport() {
            ...
            frame.src = "Summary_Reports.aspx?print=1&t=" + new Date().getTime();
        }
    </script>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td style="width: 100%" align="center">
                                    ...
                                    <CR:CrystalReportViewer ID="Summary_RPRI" runat="server"
                                        AutoDataBind="true"
                                    ...
                                    <CR:CrystalReportViewer ID="Summary_RPCPPE" runat="server"
                                        AutoDataBind="true"
                                        HasToggleGroupTreeButton="False"
                                        HasCrystalLogo="False"
                                        HasSearchButton="False"
                                    ...
                                    <CR:CrystalReportViewer ID="Summary_RPCPPE_Conso" runat="server"
                                        AutoDataBind="true"
                                        HasToggleGroupTreeButton="False"
                                        HasCrystalLogo="False"
                                        HasSearchButton="False"
                                    ...
                                    <CR:CrystalReportViewer ID="Summary_SChools" runat="server"
                                        AutoDataBind="true"
                                        HasToggleGroupTreeButton="False"
                                        HasCrystalLogo="False"
                                        HasSearchButton="False"
                                    ...
                                    <CR:CrystalReportViewer ID="Summary_PAR" runat="server"
                                        AutoDataBind="true"
                                        HasToggleGroupTreeButton="False"
                                        HasCrystalLogo="False"
                                        HasSearchButton="False"
                                    ...
                                    <CR:CrystalReportViewer ID="Summary_PRS" runat="server"
                                        AutoDataBind="true"
                                        HasToggleGroupTreeButton="False"
                                        HasCrystalLogo="False"
                                        HasSearchButton="False"
