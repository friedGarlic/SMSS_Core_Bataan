...
Partial Class Records_t_StockCard_v2_MRO
    ...
    Protected Sub ddCategory_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Catch ex As Exception
            MsgeBox.CreateMessageAlertInUpdatePanel(Me.UpdatePanel1, "Category Selected is currently unavailable.")
    ...
    Public Sub UpdateMedicines()
        ...
        If String.IsNullOrWhiteSpace(txtMedicineUnitprice.Text) OrElse
       ...
       String.IsNullOrWhiteSpace(txtMedicineEdate.Text) Then
            MsgeBox.CreateMessageAlertInUpdatePanel(Me.UpdatePanel1, "Please fill up the required fields: Unit Cost, Quantity, Reorder Point, Expiration Date.")
            Exit Sub
        End If
    ...
    Public Sub SaveMedicines()
       ...
       String.IsNullOrWhiteSpace(txtMedicineEdate.Text) Then
            MsgeBox.CreateMessageAlertInUpdatePanel(Me.UpdatePanel1, "Please fill up the required fields: Unit Cost, Quantity, Reorder Point, Alert Date, Expiration Date")
            Exit Sub
        End If
