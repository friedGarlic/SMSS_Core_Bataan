        ...
        <td>
            <asp:GridView ID="gvVehicleLocationList" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Location" HeaderText="Location / User" Visible="false">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="width: 35%" class="column_RightBold">
                            SEARCH BY:
                            <asp:DropDownList ID="ddlVehicleSearchCriteria" runat="server" Width="60%" Style="margin-left:10px;">
