...
function fun1(e, button1){
    ...
    //function getDepValRateBuilding(Integer) {
    //     //Depreciated Rate
    ...
    //     document.getElementById("ctl00_ContentPlaceHolder1_txtBuildingDepRate").value = depval;
    ...
    //    var Salvagevalue = document.getElementById('ctl00_ContentPlaceHolder1_txtSalvageValueBuilding').value;
    ...
    //     document.getElementById("ctl00_ContentPlaceHolder1_txtBuildingdepreciatedvalue").value = (Depreciation).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');

    //    //End Depreciation

    //    //Depreciated
    //    var DepreciatedtVal = document.getElementById("ctl00_ContentPlaceHolder1_txtBuildingdepreciatedvalue").value;
    ...
    //    document.getElementById("ctl00_ContentPlaceHolder1_txtBuildingDepreciatedValueNew").value = (DepreciatedValue).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
    //    //End Depreciated
    ...
    //function getDepValRateMachine(Integer) {
    //     //Depreciated Rate
    //     var year =  document.getElementById('ctl00_ContentPlaceHolder1_txtMachineryNoYears').value;
    //     var UL =  document.getElementById('ctl00_ContentPlaceHolder1_txtMachineryUsefulLife').value;
    ...
    //     document.getElementById("ctl00_ContentPlaceHolder1_txtMachineryDepRate").value = depval;
    //     //End Depreciated Rate
    ...
    //    AcquisationCostVal = AcquisationCostVal.replace(/\,/g, '');
    //    AcquisationCostVal = parseInt(AcquisationCostVal, 10);
    //    var Salvagevalue = document.getElementById('ctl00_ContentPlaceHolder1_txtMachinerySalvageValue').value;
    //    Salvagevalue = Salvagevalue.replace(/\,/g, '');
    //    Salvagevalue = parseInt(Salvagevalue, 10);
    ...
    //    //Depreciated
    //    var DepreciatedtVal = document.getElementById("ctl00_ContentPlaceHolder1_txtequipmentdepreciatedvalue").value;
    //    DepreciatedtVal = DepreciatedtVal.replace(/\,/g, '');
    //    DepreciatedtVal = parseInt(DepreciatedtVal, 10);
    //    var DepreciatedValue = 0.00;
    //     if (DepreciatedtVal > 0) {
  ...
  calculateDepreciatedValue();
    ...
    //function getDepValRateEquipment(Integer) {
    //     //Depreciated Rate
    //     var year =  document.getElementById('ctl00_ContentPlaceHolder1_txtDefaultEquipmentNoYears').value;
    //     var UL =  document.getElementById('ctl00_ContentPlaceHolder1_txtDefaultEquipmentUsefulLife').value;
    ...
    //     document.getElementById("ctl00_ContentPlaceHolder1_txtDefaultEquipmentDepRate").value = depval;
    //     //End Depreciated Rate
    ...
    //    AcquisationCostVal = AcquisationCostVal.replace(/\,/g, '');
    //    AcquisationCostVal = parseInt(AcquisationCostVal, 10);
    //    var Salvagevalue = document.getElementById('ctl00_ContentPlaceHolder1_txtDefaultEquipmentSalvageValue').value;
    //    Salvagevalue = Salvagevalue.replace(/\,/g, '');
    //    Salvagevalue = parseInt(Salvagevalue, 10);
    ...
    //    //Depreciated
    //    var DepreciatedtVal = document.getElementById("ctl00_ContentPlaceHolder1_txtDefaultEquipmentDepValue").value;
    //    DepreciatedtVal = DepreciatedtVal.replace(/\,/g, '');
    //    DepreciatedtVal = parseInt(DepreciatedtVal, 10);
    //    var DepreciatedValue = 0.00;
    //     if (DepreciatedtVal > 0) {
    ...
    //function getDepValIntangible(Integer) {
    //     //Depreciated Rate
    //     var year =  document.getElementById('ctl00_ContentPlaceHolder1_txtIntanNoofYears').value;
    //     var UL =  document.getElementById('ctl00_ContentPlaceHolder1_txtIntanUsefullife').value;
    ...
    //     document.getElementById("ctl00_ContentPlaceHolder1_txtIntanDepreciatedRate").value = depval;
    //     //End Depreciated Rate
    ...
    //    AcquisationCostVal = AcquisationCostVal.replace(/\,/g, '');
    //    AcquisationCostVal = parseInt(AcquisationCostVal, 10);
    //    var Salvagevalue = document.getElementById('ctl00_ContentPlaceHolder1_txtIntanSalvageValue').value;
    //    Salvagevalue = Salvagevalue.replace(/\,/g, '');
    //    Salvagevalue = parseInt(Salvagevalue, 10);
    ...
    //    //Depreciated
    //    var DepreciatedtVal = document.getElementById("ctl00_ContentPlaceHolder1_txtIntanDepreciationValue").value;
    //    DepreciatedtVal = DepreciatedtVal.replace(/\,/g, '');
    //    DepreciatedtVal = parseInt(DepreciatedtVal, 10);
    //    var DepreciatedValue = 0.00;
    //     if (DepreciatedtVal > 0) {
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="width: 1010px">
                            ...
                            <asp:DropDownList ID="drpClassification" runat="server" Width="150px" AutoPostBack="True" CssClass="txtboxinspection" OnSelectedIndexChanged="drpClassification_SelectedIndexChanged"></asp:DropDownList>

                            <span style="font-size: 10pt; font-family: Arial">
                                <strong>General Account : </strong>
                            </span>
                            <asp:DropDownList ID="ddGlAccount" runat="server" Width="250px" AutoPostBack="True" CssClass="txtboxinspection"></asp:DropDownList>
                            <span style="font-size: 10pt; font-family: Arial">
                                <strong>Description : </strong>
                            </span>
                            <asp:TextBox ID="txtAccountSearch" runat="server" Width="150px" CssClass="txtboxinspection"></asp:TextBox>
                            <span style="font-size: 10pt; font-family: Arial">
                                <strong></strong>
                            </span>
                            <asp:Button ID="ItemSearch" OnClick="ItemSearch_Click" runat="server" Width="100px" Text="Search" SkinID="ButtonImage" CssClass="CSButton"></asp:Button>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <asp:MultiView ID="mwProperty" runat="server">
                                <asp:View ID="vwgridviewsearch" runat="server">
                                    <%--<asp:BoundField DataField="Item_Desc" HeaderText="Declared Owner">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            
                                <asp:BoundField DataField="Balance" HeaderText="Address">
                                <ItemStyle HorizontalAlign="Center" Width="20%"></ItemStyle>
                                </asp:BoundField>
                             <asp:BoundField DataField="Unit" HeaderText="Barangay">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>

                            <asp:BoundField DataField="Unit" HeaderText="Area">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
