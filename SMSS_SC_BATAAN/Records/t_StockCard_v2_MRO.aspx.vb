...
txtConsOthersFloor, txtConsOthersRoom, txtConsOthersShelves, txtConsOthersRack, txtConsOthersBin}
    ...
    Public Sub SaveMROSupplies()
        ...
        If String.IsNullOrEmpty(txtUnitPrice.Text) OrElse
       ...
       String.IsNullOrEmpty(txtReOrderPt.Text) Then
            ...
            "Please Fill up the required Fields: Unit Cost / Quantity / Date/ Reorder Pt")
        ...
        With objStock
            ...
            .Balance = qtyValue
            .Location = finalLocation
            .Expiration_Date = Date.Now.AddYears(10)
            .Cost = unitPriceValue
            .Issuance = 0
                ...
                If cb1.Visible AndAlso cb1.Checked Then
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        objDerived.GetRecords("UPDATE [AMS].[stock] " +
                                                ...
                                                " ,[Balance] = '" & txtEAcqCost.Text.Replace(",", "") & "' " +
                        ...
                        If IsNumeric(txtEquipmentQuantity.Text) AndAlso IsNumeric(txtEAcqCost.Text) Then
                            qty = CDec(txtEquipmentQuantity.Text)
                            unitPrice = CDec(txtEAcqCost.Text)

                            Dim lastBalanceCostQuery As String = "SELECT TOP 1 BalanceCost FROM AMS.TbStock_Ledger " &
                                     "WHERE Item_ID = '" & hdnItemNo.Value & "' AND StockID = '" & stockID & "' " &
                                     "ORDER BY StockLedger_ID DESC"

                            Dim lastBalanceCost As Decimal = 0
                            Dim dt2 = objDerived.GetDataTable(lastBalanceCostQuery, CommandType.Text)
                            If dt2.Rows.Count > 0 Then
                                lastBalanceCost = Convert.ToDecimal(dt2.Rows(0)("BalanceCost"))
                            End If

                            ' Proceed with the SQL query
                            objDerived.GetRecords("UPDATE [AMS].[TbStock_Ledger] SET " &
                                                      "DebitUnit = '" & drpMROEquipmentUnit.SelectedItem.Text & "', " &
                                                      "DebitQty = '" & qty & "', " &
                                                      "DebitCost = '" & (qty * unitPrice) & "', " &
                                                      "dDate = '" & txtEAcqDate.Text & "', " &
                                                      "BalanceUnit = '" & drpMROEquipmentUnit.SelectedItem.Text & "', " &
                                                      "BalanceCost = '" & (lastBalanceCost + (qty * unitPrice)) & "' " &
                                                      "WHERE Item_ID = '" & hdnItemNo.Value & "' AND StockID = '" & stockID & "'", CommandType.Text)
                        ...
                        ' Prepare a safe, quoted AreaCapacity value
                        Dim escapedAreaCapacity As String = (If(txtequipmentareacapacity.Text, String.Empty)).Replace("'", "''").Trim()
                        ...
                        Dim query As String = "UPDATE AMS.TbNonFood SET " &
                                              ...
                                              "AreaCapacity='" & escapedAreaCapacity & "', " &
    ...
    Public Sub UpdateConsOthers()
        ...
        Else
            ...
            Dim dt As DataTable = objDerived.GetDataTable("Exec [AMS].[sp_SuppliesLedger] '" & hdnItemNo.Value & "'", CommandType.Text)
            ...
            For i As Integer = 0 To grdLedger.Rows.Count - 1
                ...
                If cb1.Visible AndAlso cb1.Checked Then
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        ' Check if the values are numeric and convert them
                        If IsNumeric(txtConsOthersQuantity.Text) AndAlso IsNumeric(txtConsOthersUnitPrice.Text) Then
                            qty = CDec(txtConsOthersQuantity.Text)
                            unitPrice = CDec(txtConsOthersUnitPrice.Text)
                            ...
                            Dim balanceCost As Decimal = totalBalanceCost + unitPrice
    ...
    Public Sub saveConsOthers()
        Try
            ...
            If String.IsNullOrEmpty(txtConsOthersUnitPrice.Text) OrElse
           String.IsNullOrEmpty(txtSellectDateCons.Text) OrElse
                ...
                For xa As Integer = 0 To grdLedger.Rows.Count - 1
                    ...
                    If cb1.Visible AndAlso cb1.Checked Then
                        If dt.Rows.Count > 0 Then
                            ...
                            Dim dt2 As DataTable = objDerived.GetDataTable("SELECT TOP (1) * FROM AMS.TbNonFood AS a WHERE  (Item_ID = '" & drpConsOthersName.SelectedItem.Value & "')  AND (StockId = '" & dt.Rows(xa).Item("StockID").ToString() & "') ", CommandType.Text)

                            If dt2.Rows.Count > 0 Then
                                txtConsOthersForm.Text = dt2.Rows(0).Item("Form").ToString()
                ...
                For xa As Integer = 0 To grdLedger.Rows.Count - 1
                    ...
                    If cb1.Visible AndAlso cb1.Checked Then
                        If dt.Rows.Count > 0 Then
                            ...
                            AddTrace("TbNonFood SQL: SELECT TOP (1) * FROM AMS.TbNonFood AS a WHERE (Item_ID = '" & drpMROEquipmentName.SelectedItem.Value & "') AND (StockId = '" & dt.Rows(xa).Item("StockID").ToString() & "')")
                            ...
                            If dt2.Rows.Count > 0 Then
                                txtSalvageValue.Text = dt2.Rows(0).Item("SalvageValue").ToString()
                                txtUsefulLife.Text = dt2.Rows(0).Item("UsefulLife").ToString()
                                txtNoYears.Text = dt2.Rows(0).Item("NoYears").ToString()
                                txtEMarketValue.Text = dt2.Rows(0).Item("MarketValue").ToString()
                                txtequipmentwaranty.Text = dt2.Rows(0).Item("Warranty").ToString()
                                txtequipmentareacapacity.Text = dt2.Rows(0).Item("AreaCapacity").ToString()
                                txtequipmentmodel.Text = dt2.Rows(0).Item("Model").ToString()
                                txtequipmentpowerinput.Text = dt2.Rows(0).Item("PowerInput").ToString()
                                txtequipmentdimension.Text = dt2.Rows(0).Item("Dimension").ToString()
                                txtequipmentdepreciatedvalue.Text = dt2.Rows(0).Item("DepreciationValue").ToString()
                                lblequipmentdepreciatedRate.Text = dt2.Rows(0).Item("DepreciationRate").ToString()
                                txtSpecification.Text = dt2.Rows(0).Item("Specs").ToString()
                                txtequipmentdesciption.Text = dt2.Rows(0).Item("ItemDesc").ToString()
