        ...
        <ContentTemplate>
            <div>
                <table width="100%">
                        ...
                        <td style="width: 98%" align="center">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnSearchStock" runat="server" Width="145%" CssClass="CSButton" Text="Search" OnClick="btnSearchStock_Click"></asp:Button>
                    ...
                    <tr style="display: none;">
                        <td style="width: 98%" class="DivTitle" colspan=" 2">LIST OF
                            <asp:Label ID="lblClass1" runat="server" Text="Label"></asp:Label>
                        </td>
                    </tr>
                    <tr style="display: none;">
                        <td style="width: 1%"></td>
                                                ...
                                                <table width="100%">
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <table style="width: 100%">
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 35%" class="column_Left">
                                                                            <asp:TextBox ID="txtFoodBatch" runat="server" Width="98%" CssClass="txtbox_Var"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width: 15%" class="column_RightBold">Lot :</td>
                                                                        <td style="width: 35%" class="column_Left">
                                                                            <asp:TextBox ID="txtFoodLot" runat="server" Width="98%" CssClass="txtbox_Var"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width: 15%" class="column_RightBold">Mftg. Date :</td>
                                                                        <td style="width: 35%" class="column_Left">
                                                                            <asp:TextBox ID="txtFoodMdate" runat="server" Width="50%" CssClass="txtboxinspection"></asp:TextBox>
                                                                            &nbsp;<span class="CalendarFormat">(MM/DD/YYYY)</span>
                                                                            <cc1:CalendarExtender ID="txtFoodMdateExtender" runat="server" TargetControlID="txtFoodMdate" Enabled="True" PopupButtonID="txtFoodMdate"></cc1:CalendarExtender>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width: 15%" class="column_RightBold">Expiry Date :</td>
                                                                        <td style="width: 35%" class="column_Left">
                                                                            <asp:TextBox ID="txtFoodEdate" runat="server" Width="50%" CssClass="txtbox_Date"></asp:TextBox>
                                                                            &nbsp;<span class="CalendarFormat">(MM/DD/YYYY)</span>
                                                                            <cc1:CalendarExtender ID="txtFoodEdateExtender" runat="server" TargetControlID="txtFoodEdate" Enabled="True" PopupButtonID="txtFoodEdate"></cc1:CalendarExtender>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width: 15%; color: red" class="column_RightBold">Alert :</td>
                                                                        <td style="width: 35%" class="column_Left">
                                                                            <asp:TextBox ID="txtFoodAlert" runat="server" Width="50%" CssClass="txtbox_Date"></asp:TextBox>
                                                                            &nbsp;<span class="CalendarFormat">(MM/DD/YYYY)</span>
                                                                            <cc1:CalendarExtender ID="txtFoodAlertExtender" runat="server" TargetControlID="txtFoodAlert" Enabled="True" PopupButtonID="txtFoodAlert"></cc1:CalendarExtender>
                                                                        </td>
                                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="column_Left">
                                                            <asp:TextBox ID="txtSellectDate" runat="server" CssClass="txtbox_Var"></asp:TextBox></td>
