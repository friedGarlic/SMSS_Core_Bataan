...
#End Region
    ...
    Protected Sub LoadUpdateDepreciatedValue()
        ...
        For i As Integer = 0 To dtEquip.Rows.Count - 1
            ...
            AcquisitionYear = If(IsDBNull(dtEquip.Rows(i)("Date_Accepted")), Nothing, CDate(dtEquip.Rows(i)("Date_Accepted")))
        ...
        For i As Integer = 0 To dtMach.Rows.Count - 1
            ...
            Cost = If(IsDBNull(dtMach.Rows(i)("Cost")), 0.0, CDbl(dtMach.Rows(i)("Cost")))
