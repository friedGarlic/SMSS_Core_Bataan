            ...
            <tr>
              ...
              <tr>
                ...
                <td style="width: 98%" align="left">
                    ...
                    <br />
                    <asp:DropDownList ID="drpListofReport" CssClass="drpdownCSS" runat="server" AutoPostBack="true" Width="120px" OnSelectedIndexChanged="drpListofReport_SelectedIndexChanged">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td style="width: 100%" align="center">
                                    <CR:CrystalReportViewer ID="PropertyCardReports" runat="server" AutoDataBind="true" HasToggleGroupTreeButton="False" HasCrystalLogo="False" HasSearchButton="False" HasDrilldownTabs="False"  BestFitPage="False" BackColor="#ffffff" Height="930px" Width="980px" BorderStyle="Solid" BorderColor="#2977dc" BorderWidth="1px" />
