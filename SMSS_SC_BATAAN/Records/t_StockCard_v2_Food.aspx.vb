...
Partial Class Records_t_StockCard_v2_MRO
    ...
    Public Sub MultiviewSupplier()
        ...
        dtitemdesc = objDerived.GetDataTable("SELECT a.Item_ID, a.Item_Desc FROM dbo.m_item AS a INNER JOIN ams.item_particular AS c ON a.item_particular_id = c.item_particular_id LEFT OUTER JOIN dbo.m_item_detail AS b ON a.Item_ID = b.Item_ID WHERE a.ClassificationID = " & ddClass.SelectedValue() & " ORDER BY Item_Desc", CommandType.Text)
        drpFoodName.DataSource = dtitemdesc
        drpFoodName.DataTextField = ("Item_Desc")
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        ...
        Else
            ...
            With objStockLedger
                ...
                .CreditUnit = "-"
                .CreditCost = "0.00"
                .dDate = ValidateDateInput(txtDate.Text, DateTime.Now)
                .Item_ID = hdnItemNo.Value
    ...
    Public Sub saveFood()
        ...
        If txtFoodBrandName.Text = "" Or txtFoodUnitprice.Text = "" Or txtFoodQuantity.Text = "" Or txtFoodReOrderPt.Text = "" Or txtFoodMdate.Text = "" Or txtFoodEdate.Text = "" Then
