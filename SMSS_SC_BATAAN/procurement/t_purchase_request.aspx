<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="t_purchase_request.aspx.vb" Inherits="Procurement_t_purchase_request"
                            ...
                            <table width="90%">
                                <tr>
                                    ...
                                    <td style="width: 20%" class="column_Left">
                                     <asp:DropDownList ID="ddlFilterBy" runat="server" Width="200px" CssClass="drpdownCSS" AutoPostBack="True" OnSelectedIndexChanged="ddlFilterBy_SelectedIndexChanged">
                                        ...
                                        <asp:MultiView ID="MultiView1" runat="server">
                                            ...
                                            <asp:View ID="View4" runat="server">
                                                <table style="width: 100%">
                                                    <tbody>
                                                        <tr>
                                                            <td style="width: 20%" class="column_RightBold">Select Department:</td>
                                                            <td style="width: 80%" class="column_Left">
                                                                <asp:DropDownList ID="ddlDepartment" runat="server" Width="250px" CssClass="drpdownCSS"
                                                                    AutoPostBack="True" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                                &nbsp;<asp:Button ID="btnSearchDepartment" runat="server" Width="120px" CssClass="CSButton" 
                                                                    Text="SEARCH" OnClientClick="StartProgressBar();"></asp:Button>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
