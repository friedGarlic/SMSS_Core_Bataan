<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="t_ppmplist_RepQueries.aspx.vb"
    Inherits="RepQueries_t_ppmplist" Title="PPMP List" StylesheetTheme="SkinFile" %>
                    ...
                    <td align="center" style="width: 1000px">
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td align="center" style="vertical-align: top; width: 50%">
                                    <asp:GridView ID="grdAccounts" runat="server" Width="100%" BorderStyle="Solid" DataKeyNames="GA_ID,BGA_ID,Project_ID,Program_id" 
