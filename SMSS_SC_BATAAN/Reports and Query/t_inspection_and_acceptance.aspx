<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="t_inspection_and_acceptance.aspx.vb" Inherits="Reports_and_Query_t_inspection_and_acceptance"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <!-- Modified script block: using vanilla JS instead of jQuery -->
                                                ...
                                                <table style="width: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 80%" class="column_Left">
                                                            ...
                                                            &nbsp;<asp:Button ID="btnSearchPO" runat="server" Width="120px" CssClass="CSButton" OnClientClick="StartProgressBar();" Text="Search"></asp:Button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </asp:View>
