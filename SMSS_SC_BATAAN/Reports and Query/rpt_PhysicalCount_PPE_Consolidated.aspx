...
CodeFile="rpt_PhysicalCount_PPE_Consolidated.aspx.vb" 
Inherits="Reports_and_Query_rpt_PhysicalCount_PPE_Consolidated" title="Untitled Page" %>
...
<table style="width: 1000px">
    ...
    <cr:crystalreportsource id="CrystalReportSource1" runat="server">
        <Report FileName="rpt_PhysicalCount_PPE_Consolidated.rpt">
        </Report>
    </cr:crystalreportsource><cr:crystalreportsource id="Crystalreportsource2" runat="server">
        <Report FileName="rpt_Consolidated_PhysicalCount_PPE.rpt">
        </Report>
