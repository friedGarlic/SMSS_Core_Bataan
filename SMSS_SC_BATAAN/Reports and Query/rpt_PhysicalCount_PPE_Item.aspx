...
CodeFile="rpt_PhysicalCount_PPE_Item.aspx.vb" Inherits="Reports_and_Query_rpt_PhysicalCount_PPE_Item" 
title="PHYSICAL COUNT OF PPE - BY ITEM" %>
...
<table style="width: 1000px">
    ...
    <cr:crystalreportsource id="CrystalReportSource1" runat="server">
        <Report FileName="rpt_PhysicalCount_PPE_Item.rpt">
        </Report>
