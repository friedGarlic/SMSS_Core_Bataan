<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="NoAIR.aspx.vb"
    Inherits="Reports_and_Query_NoAIR" StylesheetTheme="SkinFile" %>
        ...
        <ContentTemplate>
            ...
            <table cellspacing="1" style="width: 1010px">
                ...
                <asp:TextBox runat="server" ID="txtSearch" Width="150px" CssClass="txtboxinspection"></asp:TextBox>
                        &nbsp;<asp:Button ID="btnSearch" runat="server"  CssClass="CSButton" Text="SEARCH" Width="150px" OnClientClick="StartProgressBar();"/>
                    </td>
                </tr>
                <tr>
                    <td width="10px"></td>
