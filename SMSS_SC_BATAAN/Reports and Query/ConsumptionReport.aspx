<%@ Page Title="CONSUMPTION REPORT" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="ConsumptionReport.aspx.vb" Inherits="Reports_and_Query_ConsumptionReport" StylesheetTheme="SkinFile" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
               ...
               <tr>
                    ...
                    <td width="1000px" style="align-content:center">
                               <asp:Button ID="BtnPreview" runat="server" Text="PREVIEW" Width="200px" />
                    </td>
                </tr>
                <tr>
                    <td width="10px"></td>
