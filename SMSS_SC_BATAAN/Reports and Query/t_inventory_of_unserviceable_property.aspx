...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 98%" align="center">
                            ...
                            &nbsp;<asp:Button ID="btnpreview" runat="server" Width="150px" CssClass="CSButton" Enabled="False" SkinID="ButtonImage" Text="PREVIEW ITB"></asp:Button>
                        </td>
                        <td style="width: 1%"></td>
                    </tr>
                    <tr>
            ...
            <asp:Panel Style="display: none" ID="Panel4" runat="server" Width="900px">
                <table id="Table1" height="486" cellspacing="0" cellpadding="0" width="747" border="0">
                    <tbody>
                        <tr>
                            <td colspan="2">
                                <%--<img height="1" alt="" src="../images/modalpopup_01.png" width="747" />--%>
                        ...
                        <tr>
                            <td style="background-image: url(../../images/modalpopup_04.png); vertical-align: top; width: 772px; height: 451px" id="Td1">
                                <table style="width: 705px; height: 336px" cellspacing="0" cellpadding="0" border="0">
                                    <tbody>
                                        <tr>
                                            <td style="vertical-align: top; width: 4%; height: 398px; text-align: center"></td>
                                                                        ...
                                                                        <table style="width: 100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="width: 20%" class="column_RightBold">Search : </td>
                                                                                    <td style="width: 80%" class="text5">
                                                                                        <asp:TextBox ID="txtSupSearch" runat="server" Width="70%" CssClass="text"></asp:TextBox><asp:Button ID="btnSupSearch" OnClick="btnSupSearch_Click" runat="server" Width="100px" OnClientClick="StartProgressBar();" Text="SEARCH"></asp:Button></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 100%; text-align: center">
                                                <asp:Button ID="btnLoadSupp" OnClick="btnLoadSupp_Click" runat="server" Width="150px" Text="LOAD"></asp:Button></td>
                                        </tr>
                                    </tbody>
                                </table>
                                &nbsp;</td>
