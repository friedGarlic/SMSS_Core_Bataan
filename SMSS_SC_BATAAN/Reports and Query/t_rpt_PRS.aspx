...
<asp:UpdatePanel id="UpdatePanel1" runa0t="server">   
<contenttemplate>
...
<asp:ListItem Value="3">Date (Duration)</asp:ListItem>
    ...
    <asp:GridView id="grdPRS" runat="server" Width="95%" Font-Size="9pt" OnSelectedIndexChanged="grdPRS_SelectedIndexChanged" DataKeyNames="Returned_ID" AutoGenerateColumns="False" SkinID="GridViewAA" EmptyDataText="NO DATA FOUND">
    <Columns>
