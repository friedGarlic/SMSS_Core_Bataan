...
Partial Class Inventory_Disposal_Disposal_ISSP
    ...
    Protected Sub LoadPage()
        ...
        grdISSP.Columns(7).Visible = True
            ...
            drpSignatory.DataSource = objDerived.GetDataTable("SELECT A.EmpID, B.Full_Name FROM AMS.BAC_DisposalCommittee AS A INNER JOIN HRMS.view_signatory AS B ON A.EmpID = B.EmpID WHERE A.isActive = 1 ORDER BY Full_Name", CommandType.Text)
